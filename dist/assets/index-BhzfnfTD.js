(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const d of l)if(d.type==="childList")for(const v of d.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&i(v)}).observe(document,{childList:!0,subtree:!0});function o(l){const d={};return l.integrity&&(d.integrity=l.integrity),l.referrerPolicy&&(d.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?d.credentials="include":l.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(l){if(l.ep)return;l.ep=!0;const d=o(l);fetch(l.href,d)}})();const K={user:{name:"",role:"Student",university:"",department:"",avatar:"",isSetup:!1,isPremium:!1,language:"en",themePreference:"emerald",bgPreference:"default"},stats:{courses:{total:0,new:0},completed:{total:0,label:"No courses completed",count:0},challenges:{total:0,label:"No active challenges"},streak:{total:0,label:"No streak yet"}},chartData:[{day:"Mon",study:0,exam:0},{day:"Tue",study:0,exam:0},{day:"Wed",study:0,exam:0},{day:"Thu",study:0,exam:0},{day:"Fri",study:0,exam:0},{day:"Sat",study:0,exam:0},{day:"Sun",study:0,exam:0}],examSchedule:[{date:15,day:"W"},{date:16,day:"T"},{date:17,day:"F"},{date:18,day:"S"},{date:19,day:"S"},{date:20,day:"M"},{date:21,day:"T"}],courses:[],notebook:{notes:[{id:1,title:"My First Note",content:"<h3>Welcome to your Digital Notebook!</h3><p>This looks just like a spiral notebook, but acts like a Word doc.</p><ul><li><b>Bold</b> text</li><li><i>Italic</i> text</li></ul>",date:new Date().toISOString(),category:"General"}]},todos:[],weeklySchedule:{events:{}},exams:[],cheatsheets:[]},oe=localStorage.getItem("studyhub_data");let Y=K;if(oe)try{const t=JSON.parse(oe);Y={...K,...t},Y.exams||(Y.exams=K.exams),Y.cheatsheets||(Y.cheatsheets=K.cheatsheets)}catch(t){console.error("Failed to parse stored data",t)}const p=Y;function z(){try{localStorage.setItem("studyhub_data",JSON.stringify(p))}catch(t){console.error("Failed to save data to localStorage:",t),t.name==="QuotaExceededError"&&console.warn("LocalStorage quota exceeded. Consider clearing old data.")}}const ne={en:{dashboard:"Dashboard",schedule:"Schedule",courses:"Courses",exams:"Exams",notebook:"Notebook",cheatsheets:"Cheatsheets",pomodoro:"Pomodoro",settings:"Settings",notes:"Notes",cheats:"Cheats",hello:"Hello",search_placeholder:"Search...",premium:"Premium",premium_active:"Premium Active",total_courses:"Total Courses",completed:"Completed",studyai:"StudyAI",hours_spent:"Hours Spent",time:"Time",quick_notes:"Quick Notes",scratchpad:"Scratchpad",scratchpad_browse:"Browse",scratchpad_draw:"Draw",scratchpad_save_gallery:"Save to Gallery",scratchpad_clear:"Clear",scratchpad_select_image:"Select an image to load",scratchpad_no_sketches:"No saved sketches",focus_timer:"Focus Timer",profile:"Profile",calendar:"Calendar",todo_list:"Todo List",calculator:"Calculator",bookmarks:"Bookmarks",grade_calculation:"Grade Calculation",stopwatch:"Stopwatch",mini_games:"Mini Games",daily_habits:"Daily Habits",weekly_schedule:"Weekly Schedule",photo_frame:"Photo Frame",general:"General",language:"Language",about:"About",developer:"Developer",theme_color:"Theme Color",personalize_accent:"Personalize your accent color.",background_style:"Background Style",default:"Default",tinted:"Tinted",preview_mode:"Preview Mode",preview_mode_desc:"The entire app adapts to your adjustments immediately.",save_layout:"Save Current Layout",reset_layout:"Reset Default Layout",data_backup:"Data Backup & Restore",export_data:"Export Data",import_data:"Import Data",current_plan:"Current Plan",basic_plan:"Basic Plan",free:"Free",upgrade:"Upgrade",active:"Active",changes_saved:"Changes are saved automatically.",version:"Version",basic_edition:"Basic Edition",available_widgets:"Available Widgets",drag_remove:"Drag widget here to remove",loading_summary:"Loading summary...",layout_settings:"Layout Settings",layout_desc:"Customize how your dashboard looks.",data_desc:"Export your data to JSON or restore from a backup.",premium_plan:"Premium Plan",remove_avatar:"Remove Avatar",your_name_placeholder:"Your Name",uni_name_placeholder:"University Name",major_placeholder:"Major / Dept",developer_mode:"Developer Mode",dev_desc:"Experimental features and overrides.",enable_premium:"Enable Premium",unlock_desc:"Unlocks all premium features.",lets_known_you:"Let's get to know you",call_you:"Tell us what to call you.",full_name:"Full Name",academic_profile:"Academic Profile",personalize_dashboard:"This helps us personalize your dashboard.",university:"University / School",department:"Department / Major",make_yours:"Make it yours",choose_base_color:"Choose a base color and tweak it.",base_color:"Base Color",next_step:"Next Step",get_started:"Get Started",back:"Back",step:"Step",name_placeholder:"e.g. John Doe",uni_placeholder:"e.g. MIT",dept_placeholder:"e.g. Computer Science",clean_gray:"Clean Gray/White",theme_tint:"Theme Tint",pastel_look:"Pastel Look",add_photo_widget:"Add Photo Widget",manage_widgets:"Manage Widgets",all_widgets_active:"All widgets are active",coming_soon:"Coming Soon",optional:"Optional",summary_prefix:"You have",summary_suffix:"",classes:"classes",todos:"to-dos",months:["January","February","March","April","May","June","July","August","September","October","November","December"],days_short:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],no_events:"No events scheduled.",events_on:"Events on",tbd:"TBD",clear_schedule:"Clear Schedule",clear_all_q:"Clear All?",clear_all_desc:"This will remove all entries.",yes:"Yes",no:"No",tasks_count:"Tasks",add_new_task_placeholder:"Add a new task...",no_tasks_yet:"No tasks yet",add_one_to_start:"Add one above to get started",delete_task_confirm:"Delete this task?",cancel:"Cancel",delete:"Delete",save:"Save",task_name_placeholder:"Task Name",add_task_prompt:"Add Task for",logout:"Logout",hour_unit:"hrs",exams_title:"Exams",add_exam:"Add Exam",no_exams_yet:"No Exams Yet",no_exams_desc:"Relax! You have no upcoming exams scheduled. Add one to start tracking.",days_left:"DAYS LEFT",edit_profile:"Edit Profile",save_changes:"Save Changes",fill_all_fields:"Please fill in all fields",name_label:"Name",university_label:"University",department_label:"Department",today_caps:"TODAY",passed_caps:"PASSED",new_exam_setup:"New Exam Setup",edit_exam_setup:"Edit Exam Setup",step_1_basic:"Step 1 of 2: Basic Info",step_2_logistics:"Step 2 of 2: Logistics",course_name:"Course Name",course_code:"Course Code",exam_type:"Exam Type",date:"Date",time:"Time",location_platform:"Location / Platform",delete_exam_confirm:"Delete Exam?",action_undone:"This action cannot be undone.",edit_exam:"Edit Exam",delete_exam:"Delete Exam",my_courses:"My Courses",new_course:"New Course",no_courses_yet:"No Courses Yet",no_courses_desc:"Add your first course to get started tracking your progress.",course_caps:"COURSE",no_details:"No details added",view_details:"View details",new_course_setup:"New Course Setup",create_course:"Create Course",instructor:"Instructor",email:"Email",schedule_time:"Schedule",note_optional:"Note (Optional)",delete_course_confirm:"Delete Course?",edit_course_setup:"Edit Course Setup",note_placeholder:"Any initial thoughts...",course_not_found:"Course not found",back_to_courses:"Back to Courses",course_info:"COURSE INFO",edit:"Edit",not_set:"Not set",resources:"Resources",add_file:"Add File",no_resources_yet:"No resources yet",unknown_type:"Unknown Type",delete_resource_confirm:"Delete Resource?",gemini_powered:"Gemini Powered",chat_history:"Chat History",new_chat:"New Chat",ask_question_placeholder:"Ask a question about",ai_mistakes_disclaimer:"AI can make mistakes. Verify important info.",delete_session_confirm:"Delete Chat?",session_deleted_desc:"This chat session will be deleted.",clear_history_confirm:"Clear History?",chats_lost_desc:"Chats will be permanently lost.",new_conversation:"New Conversation",instructor_name:"INSTRUCTOR NAME",save_changes_btn:"Save Changes",digital_notebook:"Digital Notebook",welcome_notebook:"Welcome to Notebook",welcome_msg:"Welcome!",welcome_desc:"This is your new digital notebook.",index:"Index",untitled_note:"Untitled Note",empty_note:"Empty note...",page_num:"Page",new_notebook:"New Notebook",select_page_msg:"Select a page or create new",tear_out_confirm:"Tear Out Page?",remove_note_desc:"This note will be permanently removed.",tear_out:"Tear Out",page_title_placeholder:"Page Title...",page_title_placeholder:"Page Title...",start_writing:"Start writing here...",bold:"Bold",italic:"Italic",underline:"Underline",text_color:"Text Color",highlight_color:"Highlight Color",align_text:"Align Text",toggle_paper:"Toggle Paper Style",prev_page:"Previous Page",next_page:"Next Page",delete_page:"Delete Page",welcome_title:"Welcome to Notebook",welcome_body:"<h3>Welcome to your Digital Notebook!</h3><p>This looks just like a spiral notebook, but acts like a Word doc.</p><br><p><b>Bold text</b></p><p><i>Italic text</i></p>",new_note:"New Note",no_cheatsheets_yet:"No Cheatsheets Yet",create_first_sheet:"Create your first formula sheet, code snippet, or summary note.",edit_title:"Edit Title",delete_note_confirm:"Delete Note?",enter_title_start:"Enter a title to get started.",new_note_placeholder:"e.g. Physics Formulas",edit_note:"Edit Note",update_note_title:"Update your note title.",attachment:"Attachment",title:"Title",sheet_not_found:"Sheet not found!",markdown_editor:"Markdown Editor",supports_md:"Supports MD",start_typing_placeholder:"Start typing your notes here...",attachments_title:"Attachments",add_image:"Add Image",no_images_yet:"No images yet",delete_image:"Delete Image?",delete_image_desc:"This cannot be undone.",total_courses:"Total Courses",completed:"Completed",studyai:"StudyAI",hours_spent:"Hours Spent",log_flow:"Log Flow",record_session:"Record your study session.",save_entry:"Save Entry",total_streak:"Total Streak",days_l:"days",todos:"Todos",habits:"Habits",stuck_msg:"Stuck? I am here to help!",ask_studyai:"Ask StudyAI",calculator:"Calculator",time_title:"Time",switch_mode:"Switch Mode",daily_habits:"Daily Habits",done:"Done",no_habits_msg:"No habits defined. Add one!",new_habit_placeholder:"New habit...",add_photo:"Add Photo",change_photo:"Change Photo",zoom_image:"Zoom Image",remove_photo:"Remove Photo",delete_photo_confirm:"Delete Photo?",delete:"Delete",delete_photo_confirm:"Delete Photo?",delete:"Delete",cancel:"Cancel",image_too_large:"Image is too large. Please select an image under 5MB.",storage_full:"Storage full. Cannot save image.",dashboard_photo_alt:"Dashboard Photo",focus_timer:"Focus Timer",work:"Work",break:"Break",time_break_msg:"Time for a break! Good job.",break_over_msg:"Break is over! Back to work.",timer_complete:"Timer Complete",stopwatch:"Stopwatch",reset:"Reset",start:"Start",stop:"Stop",bookmarks:"Bookmarks",bookmarks:"Bookmarks",learning:"Learning",google_ai_desc:"Google AI Assistant",openai_chat_desc:"OpenAI Chat",youtube_desc:"YouTube",quick_notes:"Quick Notes",no_notes_yet:"No saved notes yet",create_one:"Create one",browse:"Browse",new:"New",type_ideas:"Type your ideas here...",add_note:"Add Note",update_note:"Update Note",saved_msg:"Saved!",mode_now:"Mode now",untitled_note:"Untitled Note",grade_calc:"Grade Calculation",assessment:"ASSESSMENT",grade:"GRADE",calculate:"Calculate",enter_grades_msg:"Enter grades to calculate",current_avg:"Current Avg",need_score_msg:"Need",on_msg:"on",for_msg:"for",impossible:"Impossible?",passed_msg:"You passed!",assessment_name:"Name",midterm:"Midterm",final_exam:"Final",new_assessment:"New",mini_games:"Mini Games",yes_no:"Yes / No",decision_maker:"Decision maker",decide:"Decide",random_picker:"Random Picker",choice_generator:"Choice generator",add_option_placeholder:"Add option...",pick_random:"Pick Random",winner:"Winner",again:"Again",option_a:"Option A",option_b:"Option B",maybe:"MAYBE",ans_yes:"YES",ans_no:"NO",upgrade_to:"Upgrade to",unlock_potential:"Unlock the full potential of your study workflow.",forever:"/ forever",essential_tools:"Essential tools for everyday studying.",standard_dashboard:"Standard Dashboard",basic_analytics:"Basic Analytics",limited_ai:"Limited AI Assistance",cloud_sync_backup:"Cloud Sync & Backup",advanced_customization:"Advanced Customization",recommended:"Recommended",per_month:"/ month",premium_desc:"For serious students who want the best.",unlimited_ai:"Extended AI Tutor",cloud_sync_multi:"Cloud Sync & Multi-Device",advanced_analytics:"Advanced Performance Analytics",custom_themes:"Custom Themes & Icons",upgrade_now:"Coming Soon",secure_payment:"Secure payment processed by Stripe. Cancel anytime.",logout_confirmation_title:"Log Out?",logout_confirmation_desc:"Are you sure you want to exit? You will return to the setup screen.",reset_layout_confirm:"Are you sure you want to reset the dashboard layout to default?",overwrite_confirm:"This will overwrite your current data. Are you sure?",invalid_backup:"Invalid backup file. Missing critical data.",parse_error:"Error parsing backup file.",no_courses_completed:"No courses completed",no_active_challenges:"No active challenges",no_streak_yet:"No streak yet",student_role:"Student",security_lock:"Access Dev"},tr:{dashboard:"Panel",schedule:"Takvim",courses:"Dersler",exams:"Sınavlar",notebook:"Not Defteri",cheatsheets:"Kopyalar",pomodoro:"Pomodoro",settings:"Ayarlar",notes:"Notlar",cheats:"Kopyalar",hello:"Merhaba",search_placeholder:"Ara...",premium:"Premium",premium_active:"Premium Aktif",total_courses:"Toplam Ders",completed:"Tamamlanan",studyai:"StudyAI",hours_spent:"Harcanan Saat",log_flow:"Akışı Kaydet",record_session:"Çalışma oturumunu kaydet.",save_entry:"Girişi Kaydet",time:"Zaman",quick_notes:"Hızlı Notlar",scratchpad:"Karalama Defteri",scratchpad_browse:"Gözat",scratchpad_draw:"Çiz",scratchpad_save_gallery:"Galeriye Kaydet",scratchpad_clear:"Temizle",scratchpad_select_image:"Yüklemek için bir görsel seç",scratchpad_no_sketches:"Kayıtlı çizim yok",scratchpad_select_image:"Yüklemek için seç",focus_timer:"Odaklanma",profile:"Profil",calendar:"Takvim",todo_list:"Yapılacaklar",calculator:"Hesap Makinesi",bookmarks:"Yer İşaretleri",grade_calculation:"Not Hesaplama",stopwatch:"Kronometre",mini_games:"Oyunlar",daily_habits:"Günlük Alışkanlıklar",weekly_schedule:"Haftalık Program",photo_frame:"Fotoğraf Çerçevesi",general:"Genel",language:"Dil",about:"Hakkında",developer:"Geliştirici",theme_color:"Tema Rengi",personalize_accent:"Vurgu rengini kişiselleştir.",background_style:"Arkaplan Stili",default:"Varsayılan",tinted:"Renkli",preview_mode:"Önizleme Modu",preview_mode_desc:"Tüm uygulama değişikliklere anında uyum sağlar.",save_layout:"Düzeni Kaydet",reset_layout:"Varsayılan Düzeni Sıfırla",data_backup:"Veri Yedekleme & Geri Yükleme",export_data:"Veriyi Dışa Aktar",import_data:"Veriyi İçe Aktar",current_plan:"Mevcut Plan",basic_plan:"Temel Plan",free:"Ücretsiz",upgrade:"Yükselt",active:"Aktif",changes_saved:"Değişiklikler otomatik kaydedilir.",version:"Sürüm",basic_edition:"Temel Sürüm",available_widgets:"Mevcut Widgetlar",drag_remove:"Kaldırmak için buraya sürükle",loading_summary:"Özet yükleniyor...",layout_settings:"Düzen Ayarları",layout_desc:"Panelinin nasıl görüneceğini özelleştir.",data_desc:"Verilerini JSON olarak dışa aktar veya yedekten geri yükle.",premium_plan:"Premium Plan",remove_avatar:"Avatarı Kaldır",your_name_placeholder:"Adın",uni_name_placeholder:"Üniversite Adı",major_placeholder:"Bölüm",developer_mode:"Geliştirici Modu",dev_desc:"Deneysel özellikler ve geçersiz kılmalar.",enable_premium:"Premium'u Etkinleştir",unlock_desc:"Tüm premium özelliklerin kilidini açar.",lets_known_you:"Seni tanıyalım",call_you:"Sana nasıl hitap edelim?",full_name:"Ad Soyad",academic_profile:"Akademik Profil",personalize_dashboard:"Bu, paneli kişiselleştirmemize yardımcı olur.",university:"Üniversite / Okul",department:"Bölüm",make_yours:"Senin olsun",choose_base_color:"Bir renk seç ve özelleştir.",base_color:"Ana Renk",next_step:"Sonraki Adım",get_started:"Başla",back:"Geri",step:"Adım",name_placeholder:"örn. Ahmet Yılmaz",uni_placeholder:"örn. İstanbul Üniversitesi",dept_placeholder:"örn. Bilgisayar Mühendisliği",clean_gray:"Temiz Gri/Beyaz",theme_tint:"Tema Tonu",pastel_look:"Pastel Görünüm",logout:"Çıkış Yap",add_photo_widget:"Fotoğraf Widget Ekle",manage_widgets:"Widgetları Yönet",all_widgets_active:"Tüm widgetlar aktif",coming_soon:"Yakında",optional:"Opsiyonel",summary_prefix:"Toplam",summary_suffix:"var",classes:"ders",todos:"yapılacak",months:["Ocak","Şubat","Mart","Nisan","Mayıs","Haziran","Temmuz","Ağustos","Eylül","Ekim","Kasım","Aralık"],days_short:["Paz","Pzt","Sal","Çar","Per","Cum","Cmt"],no_events:"Planlanmış etkinlik yok.",events_on:"Tarihindeki Etkinlikler:",tbd:"Belirsiz",clear_schedule:"Programı Temizle",clear_all_q:"Hepsini Sil?",clear_all_desc:"Tüm girişler silinecek.",yes:"Evet",no:"Hayır",tasks_count:"Görev",add_new_task_placeholder:"Yeni görev ekle...",no_tasks_yet:"Henüz görev yok",add_one_to_start:"Başlamak için yukarıdan ekle",delete_task_confirm:"Bu görevi sil?",cancel:"İptal",course_not_found:"Ders bulunamadı",back_to_courses:"Derslere Dön",course_info:"DERS BİLGİSİ",edit:"Düzenle",not_set:"Ayarlanmadı",resources:"Kaynaklar",add_file:"Dosya Ekle",no_resources_yet:"Henüz kaynak yok",unknown_type:"Bilinmeyen Tür",delete_resource_confirm:"Kaynağı Sil?",gemini_powered:"Gemini Destekli",chat_history:"Sohbet Geçmişi",new_chat:"Yeni Sohbet",ask_question_placeholder:"Soru sor:",ai_mistakes_disclaimer:"YZ hata yapabilir. Önemli bilgileri doğrulayın.",delete_session_confirm:"Sohbeti Sil?",session_deleted_desc:"Bu sohbet oturumu silinecek.",clear_history_confirm:"Geçmişi Temizle?",chats_lost_desc:"Sohbetler kalıcı olarak silinecek.",new_conversation:"Yeni Konuşma",instructor_name:"EĞİTMEN ADI",save_changes_btn:"Değişiklikleri Kaydet",delete:"Sil",save:"Kaydet",task_name_placeholder:"Görev Adı",add_task_prompt:"Tarihi için görev ekle",hour_unit:"saat",exams_title:"Sınavlar",add_exam:"Sınav Ekle",no_exams_yet:"Henüz Sınav Yok",no_exams_desc:"Rahatla! Planlanmış sınavın yok. Takip etmek için bir tane ekle.",days_left:"GÜN KALDI",today_caps:"BUGÜN",passed_caps:"GEÇTİ",new_exam_setup:"Yeni Sınav Kurulumu",edit_exam_setup:"Sınav Düzenle",step_1_basic:"Adım 1 / 2: Temel Bilgiler",step_2_logistics:"Adım 2 / 2: Lojistik",course_name:"Ders Adı",course_code:"Ders Kodu",exam_type:"Sınav Türü",date:"Tarih",time:"Saat",location_platform:"Konum / Platform",delete_exam_confirm:"Sınavı Sil?",action_undone:"Bu işlem geri alınamaz.",edit_exam:"Sınavı Düzenle",delete_exam:"Sınavı Sil",my_courses:"Derslerim",new_course:"Yeni Ders",no_courses_yet:"Henüz Ders Yok",no_courses_desc:"İlerlemeni takip etmek için ilk dersini ekle.",course_caps:"DERS",no_details:"Detay eklenmedi",view_details:"Detayları gör",new_course_setup:"Yeni Ders Kurulumu",create_course:"Ders Oluştur",instructor:"Eğitmen",email:"E-posta",schedule_time:"Program",note_optional:"Not (İsteğe bağlı)",delete_course_confirm:"Dersi Sil?",edit_course_setup:"Dersi Düzenle",note_placeholder:"İlk düşünceler...",digital_notebook:"Dijital Defter",welcome_notebook:"Deftere Hoşgeldin",welcome_msg:"Hoşgeldin!",welcome_desc:"Bu senin yeni dijital defterin.",index:"İçindekiler",untitled_note:"Başlıksız Not",empty_note:"Boş not...",page_num:"Sayfa",new_notebook:"Yeni Defter",select_page_msg:"Bir sayfa seç veya yeni oluştur",tear_out_confirm:"Sayfayı Yırt?",remove_note_desc:"Bu not kalıcı olarak silinecek.",tear_out:"Yırt At",page_title_placeholder:"Sayfa Başlığı...",page_title_placeholder:"Sayfa Başlığı...",start_writing:"Buraya yazmaya başla...",bold:"Kalın",italic:"İtalik",underline:"Altı Çizili",text_color:"Yazı Rengi",highlight_color:"Vurgu Rengi",align_text:"Hizala",toggle_paper:"Kağıt Stilini Değiştir",prev_page:"Önceki Sayfa",next_page:"Sonraki Sayfa",delete_page:"Sayfayı Sil",welcome_title:"Not Defterine Hoşgeldin",welcome_body:"<h3>Dijital Not Defterine Hoşgeldin!</h3><p>Bu tıpkı spiralli bir defter gibi görünür ama Word belgesi gibi çalışır.</p><br><p><b>Kalın yazı</b></p><p><i>İtalik yazı</i></p>",new_note:"Yeni Not",no_cheatsheets_yet:"Henüz Kopya Kağıdı Yok",create_first_sheet:"İlk formül kağıdını, kod parçasını veya özet notunu oluştur.",edit_title:"Başlığı Düzenle",delete_note_confirm:"Notu Sil?",enter_title_start:"Başlamak için bir başlık girin.",new_note_placeholder:"örn. Fizik Formülleri",edit_note:"Notu Düzenle",update_note_title:"Not başlığını güncelle.",attachment:"Ek",title:"Başlık",sheet_not_found:"Not bulunamadı!",markdown_editor:"Markdown Editörü",supports_md:"MD Destekli",start_typing_placeholder:"Notlarını buraya yazmaya başla...",attachments_title:"Ekler",add_image:"Görsel Ekle",no_images_yet:"Henüz görsel yok",delete_image:"Görseli Sil?",delete_image_desc:"Bu işlem geri alınamaz.",total_courses:"Toplam Ders",completed:"Tamamlanan",studyai:"StudyAI",total_streak:"Toplam Seri",days_l:"gün",todos:"Görevler",habits:"Alışkanlıklar",stuck_msg:"Takıldın mı? Yardıma hazırım!",ask_studyai:"StudyAI'a Sor",calculator:"Hesap Makinesi",time_title:"Saat",switch_mode:"Mod Değiştir",daily_habits:"Alışkanlıklar",done:"Tamamlandı",no_habits_msg:"Tanımlı alışkanlık yok. Bir tane ekle!",new_habit_placeholder:"Yeni alışkanlık...",add_photo:"Fotoğraf Ekle",change_photo:"Fotoğrafı Değiştir",zoom_image:"Yakınlaştır",remove_photo:"Kaldır",delete_photo_confirm:"Fotoğrafı Sil?",delete:"Sil",delete:"Sil",cancel:"İptal",image_too_large:"Görsel çok büyük. Lütfen 5MB'dan küçük bir görsel seçin.",storage_full:"Depolama alanı dolu. Görsel kaydedilemiyor.",dashboard_photo_alt:"Panel Fotoğrafı",focus_timer:"Odaklanma",work:"Çalış",break:"Mola",time_break_msg:"Mola zamanı! İyi iş çıkardın.",edit_profile:"Profili Düzenle",save_changes:"Değişiklikleri Kaydet",fill_all_fields:"Lütfen tüm alanları doldurun",name_label:"İsim",university_label:"Üniversite",department_label:"Bölüm",break_over_msg:"Mola bitti! İşe dön.",timer_complete:"Süre Doldu",stopwatch:"Kronometre",reset:"Sıfırla",start:"Başla",stop:"Durdur",bookmarks:"Yer İmleri",bookmarks:"Yer İmleri",learning:"Öğrenme",google_ai_desc:"Google YZ Asistanı",openai_chat_desc:"OpenAI Sohbet",youtube_desc:"YouTube",quick_notes:"Hızlı Notlar",no_notes_yet:"Henüz not yok",create_one:"Oluştur",browse:"Gözat",new:"Yeni",type_ideas:"Fikirlerini buraya yaz...",add_note:"Not Ekle",update_note:"Notu Güncelle",saved_msg:"Kaydedildi!",mode_now:"Şu anki mod",untitled_note:"Başlıksız Not",grade_calc:"Not Hesaplama",assessment:"DEĞERLENDİRME",grade:"NOT",calculate:"Hesapla",enter_grades_msg:"Hesaplamak için not girin",current_avg:"Ortalama",need_score_msg:"Gereken",on_msg:"=>",for_msg:"hedefi:",impossible:"İmkansız?",passed_msg:"Geçtin!",assessment_name:"İsim",midterm:"Vize",final_exam:"Final",new_assessment:"Yeni",mini_games:"Mini Oyunlar",yes_no:"Evet / Hayır",decision_maker:"Karar verici",decide:"Karar Ver",random_picker:"Rastgele Seçici",choice_generator:"Seçim oluşturucu",add_option_placeholder:"Seçenek ekle...",pick_random:"Rastgele Seç",winner:"Kazanan",again:"Tekrar",option_a:"Seçenek A",option_b:"Seçenek B",maybe:"BELKİ",ans_yes:"EVET",ans_no:"HAYIR",upgrade_to:"",unlock_potential:"Çalışma akışının tam potansiyelini ortaya çıkar.",forever:"/ ömür boyu",essential_tools:"Günlük çalışma için temel araçlar.",standard_dashboard:"Standart Panel",basic_analytics:"Temel Analitikler",limited_ai:"Sınırlı YZ Desteği",cloud_sync_backup:"Bulut Senkronizasyon & Yedekleme",advanced_customization:"Gelişmiş Kişiselleştirme",recommended:"Önerilen",per_month:"/ ay",premium_desc:"En iyisini isteyen ciddi öğrenciler için.",unlimited_ai:"Genişletilmiş YZ Eğitmeni",cloud_sync_multi:"Bulut Senk. & Çoklu Cihaz",advanced_analytics:"Gelişmiş Performans Analizi",custom_themes:"Özel Temalar & İkonlar",upgrade_now:"Çok Yakında",secure_payment:"Stripe ile güvenli ödeme. İstediğin zaman iptal et.",logout_confirmation_title:"Çıkış Yapılsın mı?",logout_confirmation_title:"Çıkış Yapılsın mı?",logout_confirmation_desc:"Çıkmak istediğine emin misin? Kurulum ekranına döneceksin.",reset_layout_confirm:"Varsayılan düzeni sıfırlamak istediğine emin misin?",overwrite_confirm:"Mevcut verilerin üzerine yazılacak. Emin misin?",invalid_backup:"Geçersiz yedek dosyası. Kritik veriler eksik.",parse_error:"Yedek dosyası ayrıştırılamadı.",no_courses_completed:"Tamamlanan ders yok",no_active_challenges:"Aktif görev yok",no_streak_yet:"Henüz seri yok",student_role:"Öğrenci",security_lock:"Geliştirici Erişimi"}};function e(t){const n=p.user.language||"en",o=ne[n][t];return o!==void 0?o:t}function de(t,n="dashboard"){const o=[{icon:"grid",page:"dashboard"},{icon:"book",page:"courses"},{icon:"notebook",page:"notebook"},{icon:"ticket",page:"exams"},{icon:"collection",page:"cheatsheets"}],i={grid:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />',book:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />',calendar:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />',notebook:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />',chart:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />',folder:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />',collection:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />',chat:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />',globe:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />',ticket:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />'},l=o.map(d=>{const v=d.page===n;return`
    ...
    `}function ce(t,n="dashboard"){const o=[{icon:"grid",page:"dashboard",label:e("dashboard")},{icon:"book",page:"courses",label:e("courses")},{icon:"notebook",page:"notebook",label:e("notes")},{icon:"ticket",page:"exams",label:e("exams")},{icon:"collection",page:"cheatsheets",label:e("cheats")}],i={grid:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />',book:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />',notebook:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />',collection:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />',ticket:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />'},l=o.map(d=>{const v=d.page===n;return`
        <li onclick="window.navigateTo('${d.page}')" class="flex-1 cursor-pointer p-2 rounded-xl transition-all duration-300 flex flex-col items-center justify-center gap-1 ${v?"text-primary":"text-gray-400 hover:text-gray-600"}">
            <svg class="w-6 h-6 ${v?"fill-primary/10 stroke-primary":""}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ${i[d.icon]}
            </svg>
            <span class="text-[10px] font-bold ${v?"opacity-100":"opacity-0 h-0 hidden"} transition-all">${d.label||""}</span>
        </li>
    `}).join("");t.innerHTML=`
    ...
    <div id="stats-card-${s}" class="bg-white p-6 rounded-3xl shadow-sm hover:shadow-md transition-shadow draggable-item relative group flex flex-col justify-between" draggable="true">
      ...
      <div class="flex flex-col h-full">
         ...
         ${s===0&&p.courses&&p.courses.length>0?`
         <div class="mt-2 flex flex-col gap-2 overflow-y-auto max-h-40 custom-scrollbar pr-1">
            ${p.courses.map(c=>`
                <div onclick="window.navigateTo('course-detail', { id: ${c.id} })" class="flex items-center gap-2 p-2 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors group/course">
                    ...
                    <span class="text-xs font-medium text-gray-600 truncate flex-1 block" title="${c.name}">${c.name}</span>
         ...
         <div class="mt-4 flex flex-col gap-2">
             <div class="flex justify-between items-center p-2 bg-gray-50 rounded-xl border border-gray-100">
                 ...
                 <span id="stat-todo-count" class="text-xs font-bold text-dark">${n}</span>
             </div>
             <div class="flex justify-between items-center p-2 bg-gray-50 rounded-xl border border-gray-100">
                 <div class="flex items-center gap-2">
                     <span class="w-2 h-2 rounded-full bg-primary shadow-sm shadow-primary/30"></span>
                 ...
                 <span id="stat-habit-count" class="text-xs font-bold text-dark">${i}</span>
             </div>
         </div>
         `:""}
  ...
  `;return d+v}function Z(t){const n=p.chartData,o=Math.max(...n.map(u=>u.study+u.exam))||5,i=n.map(u=>{const m=o===0?1:o,w=u.study/m*100,L=u.exam/m*100;return`
  ...
  `;const l=t.querySelector("#btn-add-hours"),d=t.querySelector("#modal-log-hours"),v=t.querySelector("#close-log-hours"),a=t.querySelector("#btn-save-hours"),s=t.querySelector("#input-hours"),c=u=>{u?(d.classList.remove("invisible","opacity-0"),d.querySelector("div").classList.remove("scale-95","opacity-0"),d.querySelector("div").classList.add("scale-100","opacity-100"),setTimeout(()=>s.focus(),100)):(d.classList.add("invisible","opacity-0"),d.querySelector("div").classList.add("scale-95","opacity-0"),d.querySelector("div").classList.remove("scale-100","opacity-100"),s.value="")};l&&l.addEventListener("click",u=>{u.stopPropagation(),c(!0)}),v&&v.addEventListener("click",u=>{u.stopPropagation(),c(!1)}),a&&a.addEventListener("click",u=>{u.stopPropagation();const m=parseFloat(s.value);if(!m||m<=0){s.classList.add("animate-shake","border-red-500","bg-red-50"),setTimeout(()=>s.classList.remove("animate-shake","border-red-500","bg-red-50"),500);return}const w=new Date().toLocaleDateString("en-US",{weekday:"short"}),L=p.chartData.find(x=>x.day===w);if(L)L.study+=m,L.study=Math.round(L.study*10)/10,z(),Z(t);else{const x=p.chartData[p.chartData.length-1];x.study+=m,z(),Z(t)}}),s&&(s.addEventListener("keydown",u=>{["-","e","E","+"].includes(u.key)&&u.preventDefault(),u.key==="Enter"&&a.click()}),s.addEventListener("input",u=>{let m=parseFloat(s.value);isNaN(m)||(m<0&&(s.value=0),m>24&&(s.value=24))}))}function J(t){return t<1?1:Math.round(t)}function ae(t,n,o=[]){const i=new Date;let l=i.getMonth(),d=i.getFullYear(),v=null;const a=()=>{const s=e("months"),c=new Date(d,l+1,0).getDate(),u=new Date(d,l,1).getDay(),m=e("days_short"),w={};n.forEach(f=>{f.date&&(w[f.date]||(w[f.date]=[]),w[f.date].push({...f,isExam:!1}))}),o.forEach(f=>{if(f.date){const M=new Date(f.date),S=`${M.getFullYear()}-${String(M.getMonth()+1).padStart(2,"0")}-${String(M.getDate()).padStart(2,"0")}`;w[S]||(w[S]=[]),w[S].push({...f,isExam:!0})}});let L="";for(let f=0;f<u;f++)L+='<div class="h-8"></div>';for(let f=1;f<=c;f++){const M=`${d}-${String(l+1).padStart(2,"0")}-${String(f).padStart(2,"0")}`,S=w[M]||[],_=S.length>0,B=S.some(h=>h.isExam),j=v===M,E=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`;L+=`
                <div class="h-9 w-9 mx-auto flex items-center justify-center rounded-full cursor-pointer transition-all text-xs font-medium relative group
                    ${j?"bg-primary text-white shadow-lg scale-110":M===E?"bg-primary/20 text-primary":"hover:bg-gray-50 text-gray-500"}
                    ${_&&!j?"font-bold text-dark":""}
                " onclick="selectDate('${M}')">
                    ${f}
                    ${_?`<div class="absolute bottom-1 w-1 h-1 rounded-full ${B?"bg-red-500":j?"bg-white":"bg-primary"}"></div>`:""}
                </div>
            `}let x="";if(v){const f=w[v]||[];x=`
                <div class="mt-6 border-t border-gray-100 pt-4 animate-fade-in">
                    <div class="flex justify-between items-center mb-3">
                        <h4 class="text-sm font-bold text-dark">${e("events_on")} ${v.split("-").reverse().join("/")}</h4>
                    </div>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-sm h-full flex flex-col relative">
           <div class="flex justify-between items-center mb-4 shrink-0">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs font-bold text-dark w-24 text-center select-none">${s[l]} ${d}</span>
                <button class="p-1 hover:bg-gray-50 rounded-full" onclick="changeMonth(1)">
        ...
        `,t.selectDate=f=>{v=f,a()},t.changeMonth=f=>{l+=f,l>11&&(l=0,d++),l<0&&(l=11,d--),a()},t.addEvent=f=>{const M=f.split("-").reverse().join("/"),S=prompt(`${e("add_task_prompt")} ${M}:`);S&&(n.push({title:S,subject:"Personal",time:"All Day",completed:!1,date:f}),a(),document.dispatchEvent(new Event("dataChanged")))},t.removeEvent=f=>{const M=n.findIndex(S=>S.title===f);M>-1&&(n.splice(M,1),a(),document.dispatchEvent(new Event("dataChanged")))}};window.selectDate=s=>t.selectDate(s),window.changeMonth=s=>t.changeMonth(s),window.addEvent=s=>t.addEvent(s),window.removeEvent=s=>t.removeEvent(s),a()}function pe(t,n,o=null,i=null){t.innerHTML=`
        <div class="bg-white p-6 rounded-3xl shadow-sm h-full flex flex-col">
            <div class="flex justify-between items-center mb-4 shrink-0">
                ...
                <span class="text-xs font-bold text-gray-400 bg-gray-50 px-2 py-1 rounded-lg">${n.length} ${e("tasks_count")}</span>
            </div>
            ...
            <div class="overflow-y-auto flex-1 pr-1 custom-scrollbar">
                <ul class="space-y-4 h-full">
                    ...
                    `:""}
                    ${n.map((l,d)=>d===i?`
                                <li class="flex flex-col gap-2 bg-primary/5 p-3 rounded-xl border border-primary/20 animate-fade-in text-center" data-index="${d}">
                                    ...
                                    <div class="flex justify-center gap-2">
                                         ...
                                         <button onclick="confirmDeleteTodo(${d})" class="px-3 py-1 text-xs font-bold text-white bg-primary hover:opacity-90 rounded-lg transition-colors shadow-lg shadow-primary/30">${e("delete")}</button>
                                    </div>
                                </li>
                            `:d===o?`
                                <li class="flex flex-col gap-2 bg-gray-50 p-3 rounded-xl border border-primary/20 animate-fade-in" data-index="${d}">
                                    <input type="text" id="edit-title-${d}" value="${l.title}" class="w-full bg-white border border-gray-200 rounded-lg px-2 py-1 text-sm font-bold text-dark focus:border-primary outline-none" placeholder="${e("task_name_placeholder")}">
                                    <div class="flex gap-2">
                                        <input type="date" id="edit-date-${d}" value="${l.date||""}" class="flex-1 bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs text-gray-500 focus:border-primary outline-none">
                                        <input id="edit-time-${d}" value="${l.time||""}" class="flex-1 bg-white border border-gray-200 rounded-lg px-2 py-1 text-xs text-gray-500 focus:border-primary outline-none" type="time">
                                    </div>
                                    <div class="flex justify-end gap-2 mt-1">
                                        ...
                                        <button onclick="saveEditTodo(${d})" class="px-3 py-1 text-xs font-bold text-white bg-primary hover:opacity-90 rounded-lg transition-colors shadow-lg shadow-primary/30">${e("save")}</button>
                                    </div>
                                </li>
                            `:`
                                <li class="flex items-start gap-3 group justify-between animate-fade-in" data-index="${d}">
                                    <div class="flex items-start gap-3 flex-1">
                                        <div class="mt-1 w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center cursor-pointer hover:border-primary transition-colors toggle-btn shrink-0" onclick="event.stopPropagation(); toggleTodo(${d})">
                                            ${l.completed?'<div class="w-3 h-3 bg-primary rounded-full"></div>':""}
                                        </div>
                                        <div class="min-w-0">
                                            <div class="text-sm font-bold text-dark group-hover:text-primary transition-colors cursor-pointer toggle-text truncate ${l.completed?"line-through text-gray-400":""}" onclick="editTodo(${d})">${l.title}</div>
                                    ...
                                    <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                                        <button class="p-1.5 text-gray-400 hover:text-primary rounded-lg hover:bg-primary/10 transition-colors edit-btn" onclick="event.stopPropagation(); editTodo(${d})">
                                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                        </button>
                                        <button class="p-1.5 text-gray-400 hover:text-primary rounded-lg hover:bg-primary/10 transition-colors delete-btn" onclick="event.stopPropagation(); deleteTodo(${d})">
    ...
    `,window.addTodoFromInput||(window.addTodoFromInput=()=>{const l=document.getElementById("new-todo-input");l&&l.value.trim()&&window.addSpecificTodo&&(window.addSpecificTodo(l.value.trim()),l.value="")})}function Q(t,n){n.university||(n.university="University Name"),n.department||(n.department="Department"),t.innerHTML=`
        <div class="h-full bg-gradient-to-br from-primary/5 via-white to-primary/5 rounded-3xl shadow-sm relative overflow-hidden group p-8 flex flex-col items-center justify-center text-center isolate transition-all hover:shadow-md">
            ...
            <div class="relative mb-6 group-hover:scale-105 transition-transform duration-300">
                ...
                <div class="w-28 h-28 rounded-full p-6 bg-white relative z-10 shadow-xl ring-1 ring-gray-100 flex items-center justify-center overflow-hidden">
                    ${n.avatar?`<div class="text-6xl">${n.avatar}</div>`:'<svg class="w-full h-full text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>'}
                </div>
            </div>
            
            <!-- Info Section -->
            <div class="relative z-10 flex flex-col items-center">
                <h3 class="text-2xl font-black text-dark mb-2 tracking-tight">${n.name}</h3>
                ...
                <div class="flex flex-col items-center gap-2 mt-4 w-full">
                    <div class="flex items-center justify-center gap-2 text-xs font-medium text-gray-600 w-full">
                        ...
                        <span class="truncate tracking-wide">${n.university}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-center gap-2 text-xs font-medium text-gray-600 w-full">
                        ...
                        <span class="truncate tracking-wide">${n.department}</span>
                    </div>
                </div>
            </div>
        </div>
    `,t.querySelector(".edit-profile-btn").onclick=()=>{me(n,o=>{n.name=o.name,n.university=o.university,n.department=o.department,z(),Q(t,n),document.dispatchEvent(new Event("profileUpdated"))})}}function me(t,n){const o=document.getElementById("edit-profile-modal");o&&o.remove();const i=document.createElement("div");i.id="edit-profile-modal",i.className="fixed inset-0 z-50 flex items-center justify-center bg-dark/50 backdrop-blur-sm opacity-0 transition-opacity duration-300",i.innerHTML=`
    ...
    `,document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.remove("opacity-0"),i.querySelector("div").classList.remove("scale-95"),i.querySelector("div").classList.add("scale-100")});const l=()=>{i.classList.add("opacity-0"),i.querySelector("div").classList.remove("scale-100"),i.querySelector("div").classList.add("scale-95"),setTimeout(()=>i.remove(),300)};i.querySelector("#cancel-edit-profile").onclick=l,i.onclick=d=>{d.target===i&&l()},i.querySelector("#save-edit-profile").onclick=()=>{const d=document.getElementById("edit-name").value,v=document.getElementById("edit-university").value,a=document.getElementById("edit-department").value;d&&v&&a?(n({name:d,university:v,department:a}),l()):alert(e("fill_all_fields"))}}function ge(t){let n;try{n=JSON.parse(localStorage.getItem("dashboard_notes_list")||"[]")}catch(d){console.error("Failed to parse notes data:",d),n=[]}let o=-1,i=!1;const l=()=>{const d=n.map((w,L)=>`
...
`)[0]||e("untitled_note")}
            ...
            <div class="bg-white p-6 rounded-3xl shadow-sm h-full flex flex-col relative overflow-hidden">
                ...
                <div class="relative flex-1 min-h-0">
                    ...
                    <div class="absolute inset-0 flex flex-col transition-all duration-300 ${i?"opacity-0 pointer-events-none translate-x-full":"opacity-100 translate-x-0"}">
                         <textarea id="note-area" class="w-full flex-1 bg-gray-50 rounded-xl p-4 text-sm text-gray-600 outline-none border border-transparent focus:border-primary/20 focus:bg-white transition-all resize-none placeholder-gray-400" placeholder="${e("type_ideas")}">${o!==-1?n[o]:""}</textarea>
        ...
        `;const a=t.querySelector("#note-area"),s=t.querySelector("#save-note"),c=t.querySelector("#notes-mode-toggle"),u=t.querySelector("#create-first-note"),m=t.querySelector("#note-status");s&&(s.onclick=()=>{const w=a.value.trim();if(w){o===-1?(n.push(w),o=n.length-1):n[o]=w;try{localStorage.setItem("dashboard_notes_list",JSON.stringify(n))}catch(L){console.error("Failed to save notes:",L)}m.textContent=e("saved_msg"),m.classList.add("text-primary"),setTimeout(()=>{m&&(m.textContent="",m.classList.remove("text-primary"))},2e3)}}),c.onclick=()=>{i?(i=!1,o=-1):i=!0,l()},u&&(u.onclick=()=>{i=!1,o=-1,l()}),t.querySelectorAll('button[onclick^="deleteNote"]').forEach(w=>{w.onclick=L=>{L.stopPropagation();const x=parseInt(w.parentElement.dataset.index);n.splice(x,1);try{localStorage.setItem("dashboard_notes_list",JSON.stringify(n))}catch(f){console.error("Failed to save notes:",f)}o===x?o=-1:o>x&&o--,l()}}),t.querySelectorAll('div[onclick^="loadNote"]').forEach(w=>{w.onclick=()=>{o=parseInt(w.parentElement.dataset.index),i=!1,l()}})};l()}function he(t){let n=1500,o=1500,i=!1,l="work",d=null;const v=x=>{const f=Math.floor(x/60),M=x%60;return`${f.toString().padStart(2,"0")}:${M.toString().padStart(2,"0")}`},a=()=>{const x=t.querySelector("#pomodoro-time"),f=t.querySelector("#progress-ring-circle");if(x&&(x.textContent=v(n)),f){const S=112*Math.PI,_=S-n/o*S;f.style.strokeDashoffset=_}},s=x=>{if(i)return;let f=n+x*60;f<60&&(f=60),f>3600&&(f=3600),n=f,o=f,a()},c=()=>{const x=t.querySelector("#pomodoro-toggle-btn"),f=x.querySelector("div"),M=t.querySelectorAll(".time-control-btn");i?(clearInterval(d),i=!1,f.innerHTML='<svg class="w-6 h-6 ml-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',x.classList.remove("bg-primary","hover:opacity-90","text-white"),x.classList.add("bg-primary","hover:opacity-90","text-white"),M.forEach(S=>S.classList.remove("opacity-0","pointer-events-none"))):(i=!0,f.innerHTML='<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>',l==="work"&&(x.classList.remove("bg-primary","hover:opacity-90"),x.classList.add("bg-primary","hover:opacity-90")),M.forEach(S=>S.classList.add("opacity-0","pointer-events-none")),d=setInterval(()=>{if(n>0)n--,a();else{clearInterval(d),i=!1,new Audio("https://actions.google.com/sounds/v1/alarms/beep_short.ogg").play().catch(()=>{});const S=e(l==="work"?"time_break_msg":"break_over_msg");u(S),c()}},1e3))},u=x=>{const f=document.createElement("div");f.className="fixed top-6 right-6 bg-white p-4 rounded-2xl shadow-2xl border border-gray-100 z-[9999] flex items-center gap-4 animate-fade-in-down transition-all duration-500",f.innerHTML=`
        ...
        `,document.body.appendChild(f),setTimeout(()=>{f.parentElement&&(f.style.opacity="0",f.style.transform="translateY(-20px)",setTimeout(()=>f.remove(),500))},5e3)},m=()=>{clearInterval(d),i=!1,n=l==="work"?1500:300,o=n,a();const x=t.querySelector("#pomodoro-toggle-btn"),f=x.querySelector("div");f.innerHTML='<svg class="w-6 h-6 ml-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',x.classList.remove("bg-primary","hover:opacity-90"),x.classList.add("bg-primary","hover:opacity-90"),t.querySelectorAll(".time-control-btn").forEach(S=>S.classList.remove("opacity-0","pointer-events-none"))},w=x=>{l=x,n=l==="work"?1500:300,o=n,t.querySelector("#progress-ring-circle").classList.add("text-primary"),m()};t.innerHTML=`
    ...
    `,t.querySelector("#pomodoro-toggle-btn").addEventListener("click",c),t.querySelector("#pomodoro-reset-btn").addEventListener("click",m);const L=t.querySelector("#pomodoro-mode-toggle");L.innerHTML=`
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
        <span>${e("work")}</span>
    `,L.addEventListener("click",()=>{l==="work"?(w("break"),L.innerHTML=`
            ...
            `):(w("work"),L.innerHTML=`
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                <span>${e("work")}</span>
            `)}),t.querySelector("#decrease-time").addEventListener("click",()=>s(-1)),t.querySelector("#increase-time").addEventListener("click",()=>s(1)),a()}function ve(t){if(!t)return;let n=!0;t.innerHTML=`
    ...
    `;const o=t.querySelector("#toggle-clock-mode"),i=t.querySelector("#digital-clock"),l=t.querySelector("#analog-clock"),d=t.querySelector("#digital-time"),v=t.querySelector("#digital-date"),a=t.querySelector("#hour-hand"),s=t.querySelector("#min-hand"),c=t.querySelector("#sec-hand");o.addEventListener("click",w=>{w.preventDefault(),w.stopPropagation(),n=!n,u()}),o.addEventListener("mousedown",w=>w.stopPropagation()),o.addEventListener("dragstart",w=>{w.preventDefault(),w.stopPropagation()});function u(){n?(i.classList.remove("hidden"),l.classList.add("hidden")):(i.classList.add("hidden"),l.classList.remove("hidden"))}function m(){const w=new Date;if(n){const L=w.toLocaleTimeString("en-GB",{hour12:!1}),x=w.toLocaleDateString("en-GB",{weekday:"short",day:"2-digit",month:"short"});d.innerText=L,v.innerText=x}else{const L=w.getSeconds(),x=w.getMinutes(),f=w.getHours(),M=L/60*360,S=x/60*360+L/60*6,_=f/12*360+x/60*30;c.style.transform=`rotate(${M}deg)`,s.style.transform=`rotate(${S}deg)`,a.style.transform=`rotate(${_}deg)`}}u(),m(),setInterval(m,1e3)}function be(t){if(!t)return;let n=!1,o="#3F6F68",i=2,l="canvas",d=JSON.parse(localStorage.getItem("scratchpad_gallery")||"[]");t.innerHTML=`
    ...
    `;const v=t.querySelector("#sp-btn-browse"),a=t.querySelector("#sp-view-canvas"),s=t.querySelector("#sp-view-gallery"),c=t.querySelector("#sp-canvas"),u=c.getContext("2d"),m=t.querySelectorAll(".sp-color-btn"),w=t.querySelector("#sp-clear-canvas"),L=t.querySelector("#sp-save-gallery"),x=t.querySelector("#sp-gallery-list"),f=()=>{if(l==="canvas"){l="gallery",$(),s.classList.remove("translate-x-full"),s.classList.add("translate-x-0"),a.classList.remove("translate-x-0"),a.classList.add("-translate-x-full"),v.innerHTML=`<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg><span>${e("scratchpad_draw")}</span>`;const g=t.querySelector("#sp-tools-header");g&&g.classList.add("opacity-0","pointer-events-none")}else{l="canvas",a.classList.remove("-translate-x-full"),a.classList.add("translate-x-0"),s.classList.remove("translate-x-0"),s.classList.add("translate-x-full"),v.innerHTML=`<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg><span>${e("scratchpad_browse")}</span>`;const g=t.querySelector("#sp-tools-header");g&&g.classList.remove("opacity-0","pointer-events-none"),setTimeout(M,300)}};v.onclick=f;function M(){const g=c.parentElement.getBoundingClientRect();if(g.width!==0&&(c.width!==g.width||c.height!==g.height)){let y=null;try{c.width>0&&c.height>0&&(y=u.getImageData(0,0,c.width,c.height))}catch{}c.width=g.width,c.height=g.height,y&&u.putImageData(y,0,0)}}function S(){localStorage.setItem("scratchpad_current",c.toDataURL())}function _(){const g=localStorage.getItem("scratchpad_current");if(g){const y=new Image;y.onload=()=>u.drawImage(y,0,0),y.src=g}}const B=g=>{n=!0,r(g)},j=()=>{n=!1,u.beginPath(),S()},E=g=>{const y=c.getBoundingClientRect();return{x:(g.clientX||g.touches[0].clientX)-y.left,y:(g.clientY||g.touches[0].clientY)-y.top}},r=g=>{if(!n)return;g.preventDefault();const y=E(g);u.lineWidth=i,u.lineCap="round",u.strokeStyle=o,u.lineTo(y.x,y.y),u.stroke(),u.beginPath(),u.moveTo(y.x,y.y)};c.addEventListener("mousedown",B),c.addEventListener("mouseup",j),c.addEventListener("mousemove",r),c.addEventListener("touchstart",B),c.addEventListener("touchend",j),c.addEventListener("touchmove",r),m.forEach(g=>{g.onclick=()=>{m.forEach(y=>y.classList.remove("ring-2","ring-offset-1","ring-gray-800")),g.classList.add("ring-2","ring-offset-1","ring-gray-800"),o=g.dataset.color}}),w.onclick=()=>{u.clearRect(0,0,c.width,c.height),localStorage.removeItem("scratchpad_current")},L.onclick=()=>{const g=c.toDataURL(),y=new Date().toLocaleString();d.unshift({id:Date.now(),date:y,data:g}),localStorage.setItem("scratchpad_gallery",JSON.stringify(d));const k=L.innerHTML;L.innerHTML='<svg class="w-4 h-4 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>',setTimeout(()=>L.innerHTML=k,1500)};const b=(g,y)=>{y.stopPropagation(),d=d.filter(k=>k.id!==g),localStorage.setItem("scratchpad_gallery",JSON.stringify(d)),$()},h=g=>{const y=new Image;y.onload=()=>{u.clearRect(0,0,c.width,c.height),u.drawImage(y,0,0),S(),f()},y.src=g.data};function $(){if(x.innerHTML="",d.length===0){x.innerHTML=`
            ...
            `;return}d.forEach(g=>{const y=document.createElement("div");y.className="group relative aspect-square bg-gray-50 rounded-lg border border-gray-100 overflow-hidden cursor-pointer hover:shadow-md transition-all",y.innerHTML=`
                <img src="${g.data}" class="w-full h-full object-contain pointer-events-none opacity-80 group-hover:opacity-100 mix-blend-multiply" />
            ...
            `,y.onclick=()=>h(g),y.querySelector("button").onclick=k=>b(g.id,k),x.appendChild(y)})}setTimeout(()=>{M(),_(),window.ResizeObserver&&new ResizeObserver(()=>{M()}).observe(t)},500)}function fe(t){t.innerHTML=`
    ...
    `}function ye(t){if(!t)return;let n;try{n=JSON.parse(localStorage.getItem("grade_calc_data")||"[]")}catch(d){console.error("Failed to parse grade data:",d),n=[]}n.length===0&&(n=[{id:1,name:e("midterm"),grade:"",weight:40},{id:2,name:e("final_exam"),grade:"",weight:60}]);const o=()=>{try{localStorage.setItem("grade_calc_data",JSON.stringify(n))}catch(d){console.error("Failed to save grade data:",d)}},i=()=>{let d=0,v=0,a=0;n.forEach(m=>{const w=parseFloat(m.weight)||0,L=parseFloat(m.grade);d+=w,isNaN(L)||(v+=L*w,a+=w)});const s=a>0?(v/a).toFixed(1):0;let c="";a>0?c=`<div class="text-sm">${e("current_avg")}: <span class="font-bold text-primary text-lg">${s}</span></div>`:c=`<div class="text-sm text-gray-400">${e("enter_grades_msg")}</div>`;const u=n.find(m=>(m.name.toLowerCase().includes("final")||m.weight>30)&&(m.grade===""||isNaN(parseFloat(m.grade))));if(u&&a>0&&d>0){const w=((60*d-v)/u.weight).toFixed(1);w>0&&w<=100?c+=`<div class="text-xs text-gray-500 mt-1">${e("need_score_msg")} <b class="text-dark">${w}</b> ${e("on_msg")} ${u.name} ${e("for_msg")} 60</div>`:w>100?c+=`<div class="text-xs text-primary mt-1">${e("need_score_msg")} ${w}... ${e("impossible")}</div>`:w<=0&&(c+=`<div class="text-xs text-green-500 mt-1">${e("passed_msg")}</div>`)}return c},l=()=>{const d=t.querySelector("#gc-list");d.innerHTML="",n.forEach((v,a)=>{const s=document.createElement("div");s.className="flex items-center gap-2 mb-2",s.innerHTML=`
                <input type="text" placeholder="${e("assessment_name")}" class="w-full bg-gray-50 rounded-lg px-2 py-1 text-xs border border-transparent focus:bg-white focus:border-primary focus:outline-none transition-colors" value="${v.name}" data-idx="${a}" data-key="name">
                <input type="number" placeholder="${e("grade")}" class="w-16 bg-gray-50 rounded-lg px-2 py-1 text-xs border border-transparent focus:bg-white focus:border-primary focus:outline-none transition-colors text-center" value="${v.grade}" data-idx="${a}" data-key="grade">
                <input type="number" placeholder="%" class="w-12 bg-gray-50 rounded-lg px-2 py-1 text-xs border border-transparent focus:bg-white focus:border-primary focus:outline-none transition-colors text-center" value="${v.weight}" data-idx="${a}" data-key="weight">
                <button class="text-gray-300 hover:text-primary transition-colors" data-idx="${a}">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                </button>
            `,s.querySelectorAll("input").forEach(u=>{u.oninput=m=>{const w=m.target.dataset.key;n[a][w]=m.target.value,o()}}),s.querySelector("button").onclick=()=>{n.splice(a,1),o(),l(),t.querySelector("#gc-result").innerHTML=""},d.appendChild(s)})};t.innerHTML=`
        <div class="h-full flex flex-col p-5">
            <div class="flex justify-between items-center mb-4 cursor-move shrink-0">
                <h3 class="text-lg font-bold text-dark flex items-center gap-2">
                    <svg class="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    `,l(),t.querySelector("#gc-add-btn").onclick=()=>{n.push({id:Date.now(),name:e("new_assessment"),grade:"",weight:10}),o(),l()},t.querySelector("#gc-calc-btn").onclick=()=>{t.querySelector("#gc-result").innerHTML=i()},t.querySelector("#gc-reset-btn").onclick=()=>{n.forEach(d=>{d.grade=""}),o(),l(),t.querySelector("#gc-result").innerHTML=""}}function xe(t){if(!t)return;let n=0,o=0,i=null,l=!1;t.innerHTML=`
        <div class="h-full flex flex-col p-5">
    ...
    `;const d=t.querySelector("#sw-display"),v=t.querySelector("#sw-btn-toggle"),a=t.querySelector("#sw-btn-reset"),s=u=>{const m=new Date(u),w=String(m.getUTCMinutes()).padStart(2,"0"),L=String(m.getUTCSeconds()).padStart(2,"0"),x=String(Math.floor(m.getUTCMilliseconds()/10)).padStart(2,"0");return`<span class="align-top">${w}:</span>${L}<span class="text-gray-400 text-2xl align-baseline">.${x}</span>`};d.innerHTML=s(0);const c=()=>{o=Date.now()-n,d.innerHTML=s(o)};v.onclick=()=>{l?(clearInterval(i),l=!1,v.innerText="Start",v.classList.remove("bg-primary","hover:opacity-90"),v.classList.add("bg-primary","hover:opacity-90")):(n=Date.now()-o,i=setInterval(c,30),l=!0,v.innerText=e("stop"),v.classList.remove("bg-primary","hover:opacity-90"),v.classList.add("bg-primary","hover:opacity-90"))},a.onclick=()=>{l&&(clearInterval(i),clearInterval(i),l=!1,v.innerText=e("start"),v.classList.remove("bg-primary","hover:opacity-90"),v.classList.add("bg-primary","hover:opacity-90")),o=0,n=0,d.innerHTML=s(0)}}function we(t){if(!t)return;let n="menu",o=[];const i=()=>{if(n==="menu")t.innerHTML=`
                <div class="h-full flex flex-col p-5">
                    <div class="flex justify-between items-center mb-4 cursor-move shrink-0">
                        <h3 class="text-lg font-bold text-dark flex items-center gap-2">
                            <svg class="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            `,t.querySelector("#btn-yesno").onclick=()=>{n="yesno",i()},t.querySelector("#btn-picker").onclick=()=>{n="picker",i()};else if(n==="yesno"){t.innerHTML=`
                <div class="h-full flex flex-col p-5">
            ...
            `,t.querySelector("#btn-back").onclick=()=>{n="menu",i()};const l=t.querySelector("#yn-result");t.querySelector("#yn-decide").onclick=()=>{l.innerText="...",t.querySelector("#yn-decide").disabled=!0,setTimeout(()=>{const d=[e("ans_yes"),e("ans_no"),e("maybe"),e("ans_no"),e("ans_yes")],v=d[Math.floor(Math.random()*d.length)];l.innerText=v,v===e("ans_yes")?l.className="text-5xl font-bold text-primary mb-4 min-h-[3rem] tracking-wider":v===e("ans_no")?l.className="text-5xl font-bold text-red-500 mb-4 min-h-[3rem] tracking-wider":l.className="text-5xl font-bold text-gray-500 mb-4 min-h-[3rem] tracking-wider",t.querySelector("#yn-decide").disabled=!1},400)}}else if(n==="picker"){o.length===0&&(o=[e("option_a"),e("option_b")]),t.innerHTML=`
                <div class="h-full flex flex-col p-5">
            ...
            `,t.querySelector("#btn-back").onclick=()=>{n="menu",i()};const l=t.querySelector("#rp-input"),d=t.querySelector("#rp-add"),v=()=>{l.value.trim()&&(o.push(l.value.trim()),i())};d.onclick=v,l.onkeypress=a=>{a.key==="Enter"&&v()},t.querySelectorAll("[data-idx]").forEach(a=>{a.onclick=()=>{const s=parseInt(a.dataset.idx);o.splice(s,1),i()}}),t.querySelector("#rp-spin").onclick=()=>{if(o.length<2)return;const a=t.querySelector("#rp-result-overlay"),s=t.querySelector("#rp-winner");a.classList.remove("hidden"),s.innerText="...";let c=0;const u=setInterval(()=>{s.innerText=o[c%o.length],c++},80);setTimeout(()=>{clearInterval(u);const m=o[Math.floor(Math.random()*o.length)];s.innerText=m},1e3),t.querySelector("#rp-close-result").onclick=()=>{a.classList.add("hidden")}}}};i()}function ke(t){if(!t)return;const n=new Date().toLocaleDateString();let o;try{o=JSON.parse(localStorage.getItem("habit_tracker_data_v3")||"{}")}catch(c){console.error("Failed to parse habit data:",c),o={}}if(o.date!==n){const u=(o.habits||[]).map(m=>({...m,completed:!1}));o={date:n,habits:u};try{localStorage.setItem("habit_tracker_data_v3",JSON.stringify(o))}catch(m){console.error("Failed to save habit data:",m)}}const i=()=>{o.date=new Date().toLocaleDateString();try{localStorage.setItem("habit_tracker_data_v3",JSON.stringify(o))}catch(c){console.error("Failed to save habit state:",c)}l(),document.dispatchEvent(new Event("dataChanged"))},l=()=>{const c=o.habits.filter(x=>x.completed).length,u=o.habits.length,m=u===0?0:Math.round(c/u*100),w=t.querySelector("#hb-progress-bar"),L=t.querySelector("#hb-progress-text");w&&(w.style.width=`${m}%`),L&&(L.innerText=`${m}% ${e("done")}`)},d=()=>{const c=t.querySelector("#hb-list");if(c.innerHTML="",o.habits.length===0){c.innerHTML=`
            ...
            `;return}o.habits.forEach((u,m)=>{const w=document.createElement("div");w.className=`
            ...
            `,w.innerHTML=`
                ...
                <div class="shrink-0 flex items-center gap-2">
                     ...
                     <button class="delete-btn opacity-0 group-hover:opacity-100 p-1 text-gray-300 hover:text-primary transition-all" data-idx="${m}">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
                     </button>
                </div>
            `,w.onclick=L=>{L.target.closest(".delete-btn")||(u.completed=!u.completed,i(),d())},w.querySelector(".delete-btn").onclick=L=>{L.stopPropagation(),o.habits.splice(m,1),i(),d()},c.appendChild(w)}),l()};t.innerHTML=`
        <div class="h-full flex flex-col p-5">
            <div class="flex justify-between items-center mb-4 cursor-move shrink-0">
                <h3 class="text-lg font-bold text-dark flex items-center gap-2">
                    <svg class="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <table class="w-full border-collapse sticky-table">
                    <thead>
                        <tr>
                            ...
                            ${n.map(a=>`<th class="p-2 border-b border-gray-100 text-[10px] text-gray-400 font-bold uppercase text-center">${a}</th>`).join("")}
                        </tr>
                    </thead>
                    <tbody>
                        ${o.map((a,s)=>`
                                ...
                                ${n.map((c,u)=>{const m=`${u}-${s}`;return`
                                        <td class="p-1 border-b border-gray-50 border-r border-gray-50 last:border-r-0 relative group hover:bg-gray-50 transition-colors">
                                            <input 
                                                ...
                                                value="${p.weeklySchedule.events[m]||""}" 
                                                data-key="${m}"
                                                placeholder="..."
                                            >
                                        </td>
    ...
    `,t.querySelectorAll(".schedule-input").forEach(a=>{a.addEventListener("change",s=>{const c=s.target.dataset.key,u=s.target.value;p.weeklySchedule.events[c]=u,z()}),a.addEventListener("focus",function(){this.select()})});const i=t.querySelector("#reset-schedule-btn"),l=t.querySelector("#schedule-reset-modal"),d=t.querySelector("#confirm-schedule-reset"),v=t.querySelector("#cancel-schedule-reset");i&&l&&(i.addEventListener("click",a=>{a.stopPropagation(),l.classList.remove("invisible","opacity-0"),l.classList.add("visible","opacity-100"),l.querySelector("div").classList.remove("scale-95"),l.querySelector("div").classList.add("scale-100")}),v.addEventListener("click",a=>{a.stopPropagation(),l.classList.add("invisible","opacity-0"),l.classList.remove("visible","opacity-100"),l.querySelector("div").classList.add("scale-95"),l.querySelector("div").classList.remove("scale-100")}),d.addEventListener("click",a=>{a.stopPropagation(),p.weeklySchedule.events={},z(),ie(t)}))}function U(t){const n=()=>{const o=localStorage.getItem("photo_widget_image");let i=parseFloat(localStorage.getItem("photo_widget_zoom")||"1");o?t.innerHTML=`
                <div class="w-full h-full relative group overflow-hidden rounded-3xl bg-gray-100 flex items-center justify-center">
                    <img id="dashboard-photo-img" src="${o}" class="w-full h-full object-cover pointer-events-none transition-transform duration-100 origin-center" style="transform: scale(${i})" alt="${e("dashboard_photo_alt")}">
                    ...
                    <div id="zoom-controls" class="absolute bottom-6 bg-white px-4 py-2 rounded-xl shadow-2xl flex items-center gap-3 transition-all duration-300 opacity-0 invisible translate-y-4 z-20">
                         ...
                         <input type="range" id="zoom-slider" min="1" max="3" step="0.1" value="${i}" class="w-32 h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary">
            ...
            `:t.innerHTML=`
                ...
                <input type="file" id="photo-input" class="hidden" accept="image/*">
            `;const l=t.querySelector("#photo-input"),d=()=>{l.addEventListener("change",v=>{const a=v.target.files[0];if(a){const s=new FileReader;s.onload=c=>{const u=c.target.result;if(u.length>5*1024*1024){alert(e("image_too_large"));return}try{localStorage.setItem("photo_widget_image",u),localStorage.setItem("photo_widget_zoom","1"),n()}catch{alert(e("storage_full"))}},s.readAsDataURL(a)}})};if(o){const v=t.querySelector("#btn-change-photo"),a=t.querySelector("#btn-toggle-zoom"),s=t.querySelector("#btn-delete-photo"),c=t.querySelector("#zoom-controls"),u=t.querySelector("#zoom-slider"),m=t.querySelector("#btn-zoom-out"),w=t.querySelector("#btn-zoom-in"),L=t.querySelector("#dashboard-photo-img"),x=t.querySelector("#photo-delete-modal"),f=t.querySelector("#cancel-delete-photo"),M=t.querySelector("#confirm-delete-photo");v.addEventListener("click",_=>{_.stopPropagation(),l.click()}),a.addEventListener("click",_=>{_.stopPropagation(),c.classList.contains("invisible")?(c.classList.remove("invisible","opacity-0","translate-y-4"),c.classList.add("visible","opacity-100","translate-y-0")):(c.classList.add("invisible","opacity-0","translate-y-4"),c.classList.remove("visible","opacity-100","translate-y-0"))});const S=_=>{L.style.transform=`scale(${_})`,u.value=_,localStorage.setItem("photo_widget_zoom",_)};u.addEventListener("input",_=>{S(_.target.value)}),w.addEventListener("click",_=>{_.stopPropagation();let B=parseFloat(u.value);B=Math.min(B+.1,3),S(B)}),m.addEventListener("click",_=>{_.stopPropagation();let B=parseFloat(u.value);B=Math.max(B-.1,1),S(B)}),s.addEventListener("click",_=>{_.stopPropagation(),x.classList.remove("invisible","opacity-0"),x.classList.add("visible","opacity-100")}),f.addEventListener("click",_=>{_.stopPropagation(),x.classList.add("invisible","opacity-0"),x.classList.remove("visible","opacity-100")}),M.addEventListener("click",_=>{_.stopPropagation(),localStorage.removeItem("photo_widget_image"),localStorage.removeItem("photo_widget_zoom"),n()}),d()}else t.querySelector("#photo-placeholder").addEventListener("click",()=>{l.click()}),d()};n()}function _e(t){let n=!1;const o=()=>{const r=p.todos.filter(h=>!h.completed).length;p.todos.length>0;const b=document.getElementById("header-summary");b&&(b.innerHTML=`${e("summary_prefix")} <span class="font-bold text-dark">${p.courses.length} ${e("classes")}</span> & <span class="font-bold text-dark">${r} ${e("todos")}</span> ${e("summary_suffix")}`)};let i=null;const l=new Map,d=[{id:"stats-card-0",name:e("total_courses")},{id:"stats-card-1",name:e("completed")},{id:"stats-card-2",name:e("studyai")},{id:"chart-container",name:e("hours_spent")},{id:"time-container",name:e("time")},{id:"notes-container",name:e("quick_notes")},{id:"scratchpad-container",name:e("scratchpad")},{id:"pomodoro-container",name:e("focus_timer")},{id:"profile-container",name:e("profile")},{id:"exam-schedule-container",name:e("calendar")},{id:"todo-container",name:e("todo_list")},{id:"calculator-card",name:e("calculator")},{id:"bookmarks-container",name:e("bookmarks")},{id:"grade-calc-container",name:e("grade_calculation")},{id:"stopwatch-container",name:e("stopwatch")},{id:"games-container",name:e("mini_games")},{id:"habit-container",name:e("daily_habits")},{id:"weekly-schedule-container",name:e("weekly_schedule")},{id:"photo-container",name:e("photo_frame")}],v=()=>{const r=document.getElementById("dashboard-grid"),h=Array.from(r.children).map($=>({id:$.id,className:$.className}));localStorage.setItem("dashboardLayout",JSON.stringify(h))},a=()=>{const r=localStorage.getItem("dashboardLayout");if(r)try{const b=JSON.parse(r);if(b.some(k=>!k.id)){console.warn("Invalid layout detected (missing IDs). Resetting layout."),localStorage.removeItem("dashboardLayout");return}const $=document.getElementById("dashboard-grid"),g=document.createDocumentFragment(),y=new Set;b.forEach(k=>{let H=document.getElementById(k.id)||l.get(k.id);if(!H&&k.id.startsWith("photo-widget-")){const D=document.createElement("div");D.id=k.id,D.className=k.className||"col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",D.draggable=!0,U(D,k.id),s(D),H=D}H&&(H.className=k.className,g.appendChild(H),l.delete(k.id),y.add(k.id))}),d.forEach(k=>{if(!y.has(k.id)){const H=document.getElementById(k.id)||l.get(k.id);H&&(g.appendChild(H),l.delete(k.id),y.add(k.id))}}),Array.from($.children).forEach(k=>{l.set(k.id,k),k.remove()}),$.appendChild(g)}catch(b){console.error("Failed to load layout",b)}},s=r=>{const b=document.getElementById("dashboard-grid");if(!r.getAttribute("data-dnd-initialized")){if(r.setAttribute("data-dnd-initialized","true"),!r.querySelector(".resize-handle")&&r.id!=="weekly-schedule-container"){const h=document.createElement("div");h.className="resize-handle absolute bottom-2 right-2 w-6 h-6 bg-gray-100 hover:bg-primary rounded-full cursor-nwse-resize flex items-center justify-center shadow-sm opacity-0 group-hover:opacity-100 transition-all z-20",h.innerHTML='<svg class="w-3 h-3 text-gray-500 hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" /></svg>',h.addEventListener("click",$=>{$.preventDefault(),$.stopPropagation(),r.classList.contains("md:col-span-2")?(r.classList.remove("md:col-span-2"),r.classList.add("col-span-1"),h.title="Maximize"):(r.classList.remove("col-span-1"),r.classList.add("md:col-span-2"),h.title="Minimize"),v()}),r.appendChild(h)}r.addEventListener("dragstart",h=>{i=r,h.dataTransfer.effectAllowed="move",h.dataTransfer.setData("source","grid"),setTimeout(()=>r.classList.add("opacity-0","scale-95"),0)}),r.addEventListener("dragend",()=>{r.classList.remove("opacity-0","scale-95"),i=null,b.querySelectorAll(".draggable-item").forEach(h=>h.classList.remove("ring-2","ring-primary","ring-offset-2"))}),r.addEventListener("dragover",h=>{h.preventDefault(),i&&i!==r&&r.classList.add("ring-2","ring-primary","ring-offset-2")}),r.addEventListener("dragleave",()=>{r.classList.remove("ring-2","ring-primary","ring-offset-2")}),r.addEventListener("drop",h=>{if(h.preventDefault(),h.stopPropagation(),r.classList.remove("ring-2","ring-primary","ring-offset-2"),i&&i.dataset&&i.dataset.widgetId){const $=i.dataset.widgetId,g=l.get($);if(g){b.insertBefore(g,r),l.delete($),s(g),v();const y=document.getElementById("manage-widgets-popup");y&&y.classList.add("invisible","opacity-0","scale-95")}return}if(i&&i!==r&&!i.dataset.widgetId){const $=b,g=document.createElement("div"),y=document.createElement("div");$.insertBefore(g,r),$.insertBefore(y,i),$.insertBefore(i,g),$.insertBefore(r,y),$.removeChild(g),$.removeChild(y),setTimeout(()=>v(),50)}})}};window.toggleManageDropdown=()=>{const r=document.getElementById("manage-widgets-popup"),b=document.getElementById("manage-widgets-list");if(r&&b)if(r.classList.contains("invisible")){r.classList.remove("invisible","opacity-0","scale-95"),r.classList.add("visible","opacity-100","scale-100"),b.innerHTML="";const h=document.createElement("div");h.className="w-full py-2.5 bg-primary text-white rounded-xl font-bold text-xs shadow-lg shadow-primary/30 flex items-center justify-center gap-2 hover:opacity-90 transition-all mb-3 cursor-pointer",h.draggable=!0,h.innerHTML=`
                   <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg>
                   ${e("add_photo_widget")}
                `,h.onclick=k=>{k.preventDefault();const H=document.getElementById("dashboard-grid"),D=`photo-widget-${Date.now()}`,q=document.createElement("div");q.id=D,q.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",q.draggable=!0,U(q),H.appendChild(q),s(q),v(),r.classList.add("invisible","opacity-0","scale-95")},h.addEventListener("dragstart",k=>{i=h,k.dataTransfer.effectAllowed="copy",k.dataTransfer.setData("source","generator"),k.dataTransfer.setData("type","photo-widget"),h.classList.add("opacity-50")}),h.addEventListener("dragend",()=>{h.classList.remove("opacity-50"),i=null}),b.appendChild(h);const $=document.getElementById("dashboard-grid"),g=Array.from($.children).map(k=>k.id),y=d.filter(k=>!g.includes(k.id));if(y.length===0){const k=document.createElement("div");k.innerHTML=e("all_widgets_active"),k.className="text-xs text-gray-400 text-center py-2",b.appendChild(k)}else y.forEach(k=>{const H=document.createElement("div");H.className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors mb-2",H.draggable=!0,H.dataset.widgetId=k.id,H.innerHTML=`
                            <div class="w-2 h-2 rounded-full bg-gray-300"></div>
                            <span class="text-xs font-bold text-gray-600">${k.name}</span>
                        `,H.onclick=D=>{D.preventDefault();const q=document.getElementById("dashboard-grid"),I=l.get(k.id);if(I&&(q.appendChild(I),l.delete(k.id),s(I),v(),H.remove(),b.children.length===1)){const C=document.createElement("div");C.innerHTML=e("all_widgets_active"),C.className="text-xs text-gray-400 text-center py-2",b.appendChild(C)}},H.addEventListener("dragstart",D=>{i=H,D.dataTransfer.effectAllowed="copy",D.dataTransfer.setData("source","picker"),D.dataTransfer.setData("widgetId",k.id),H.classList.add("opacity-50")}),H.addEventListener("dragend",()=>{H.classList.remove("opacity-50"),i=null}),b.appendChild(H)})}else r.classList.add("invisible","opacity-0","scale-95"),r.classList.remove("visible","opacity-100","scale-100")};let c="general";window.toggleSettingsModal=()=>{const r=document.getElementById("settings-modal");r&&(r.classList.contains("invisible")?(r.classList.remove("invisible","opacity-0","scale-95"),r.classList.add("visible","opacity-100","scale-100"),u()):(r.classList.add("invisible","opacity-0","scale-95"),r.classList.remove("visible","opacity-100","scale-100")))},window.switchSettingsTab=r=>{c=r,u()},window.changeTheme=r=>{const b={emerald:"5 150 105",blue:"37 99 235",pink:"236 72 153",orange:"234 88 12",rose:"225 29 72",lila:"178 106 251"};b[r]&&(document.documentElement.style.setProperty("--color-primary-rgb",b[r]),p.user.themePreference=r,p.user.customThemeRgb=null,z(),u(),p.user.bgPreference==="theme"&&(document.body.style.backgroundColor=`rgb(${b[r]} / 0.04)`))},window.changeBgPreference=r=>{p.user.bgPreference=r,r==="theme"?document.body.style.backgroundColor="rgb(var(--color-primary-rgb) / 0.04)":document.body.style.backgroundColor="",z(),u()},window.updateProfileField=(r,b)=>{if(p.user[r]=b,z(),r==="name"){const $=document.getElementById("header-greeting");$&&($.innerHTML=`${e("hello")}, ${b}!`)}r==="avatar"&&u();const h=document.getElementById("profile-container");h&&(h.innerHTML="",Q(h,p.user))},window.checkDevPin=r=>{const b=document.getElementById("dev-pin-input"),h=document.getElementById("dev-lock-container");r.length>0?(b.classList.add("border-primary","bg-white"),b.classList.remove("border-gray-200","bg-gray-50")):(b.classList.remove("border-primary","bg-white"),b.classList.add("border-gray-200","bg-gray-50")),r.length===4&&(r==="0000"?(b.classList.add("text-green-500","border-green-500"),h&&h.classList.add("scale-105","opacity-0"),setTimeout(()=>{n=!0,u()},300)):(b.classList.add("animate-shake","border-red-500","text-red-500"),setTimeout(()=>{b.value="",b.classList.remove("animate-shake","border-red-500","text-red-500"),b.focus()},500)))},window.toggleDevPremium=()=>{p.user.isPremium=!p.user.isPremium,z(),u();const r=document.getElementById("header-premium-btn");r&&(p.user.isPremium?(r.classList.remove("bg-primary","text-white","shadow-primary/30"),r.classList.add("bg-amber-100","text-amber-600","border-amber-200","shadow-amber-500/10"),r.innerHTML=`
                ...
                `,r.onclick=null):(r.classList.add("bg-primary","text-white","shadow-primary/30"),r.classList.remove("bg-amber-100","text-amber-600","border-amber-200","shadow-amber-500/10"),r.innerHTML=`
                 ...
                 `,r.onclick=window.togglePremiumModal))},window.togglePremiumModal=()=>{const r=document.getElementById("premium-modal");if(r){const b=r.querySelector(".modal-content");r.classList.contains("invisible")?(r.classList.remove("invisible","opacity-0"),r.classList.add("visible","opacity-100"),b&&(b.classList.remove("scale-95"),b.classList.add("scale-100"))):(r.classList.add("invisible","opacity-0"),r.classList.remove("visible","opacity-100"),b&&(b.classList.add("scale-95"),b.classList.remove("scale-100")))}},window.exportData=()=>{if(!p.user.isPremium){togglePremiumModal();return}const r="data:text/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(p,null,2)),b=document.createElement("a");b.setAttribute("href",r);const h=new Date().toISOString().slice(0,10);b.setAttribute("download",`studyhub_backup_${h}.json`),document.body.appendChild(b),b.click(),b.remove()},window.triggerImportData=()=>{if(!p.user.isPremium){togglePremiumModal();return}let r=document.getElementById("import-file-input");r||(r=document.createElement("input"),r.type="file",r.id="import-file-input",r.accept=".json",r.className="hidden",r.onchange=window.handleFileImport,document.body.appendChild(r)),r.click()},window.handleFileImport=r=>{const b=r.target.files[0];if(!b)return;const h=new FileReader;h.onload=$=>{try{const g=JSON.parse($.target.result);g.user&&g.stats?confirm(e("overwrite_confirm"))&&(Object.keys(p).forEach(y=>delete p[y]),Object.assign(p,g),z(),location.reload()):alert(e("invalid_backup"))}catch(g){console.error(g),alert(e("parse_error"))}},h.readAsText(b),r.target.value=""};const u=()=>{const r=document.getElementById("settings-content-area");if(document.querySelectorAll(".settings-tab-btn").forEach(h=>{h.dataset.tab===c?(h.classList.add("text-primary","bg-primary/10"),h.classList.remove("text-gray-500","hover:bg-gray-50")):(h.classList.remove("text-primary","bg-primary/10"),h.classList.add("text-gray-500","hover:bg-gray-50"))}),c==="general"){const h={emerald:"5 150 105",blue:"37 99 235",pink:"236 72 153",orange:"234 88 12",rose:"225 29 72",lila:"178 106 251"},$=Object.keys(h).map(g=>{const y=h[g].split(" ").join(","),k=(p.user.themePreference||"emerald")===g;return`
                    <button onclick="changeTheme('${g}')" class="group relative h-10 rounded-xl flex items-center justify-center transition-all hover:scale-105 active:scale-95 ring-2 ring-offset-2 w-full ${k?"":"ring-transparent hover:ring-gray-200"} bg-gray-50 border border-gray-100 overflow-hidden" 
            ...
            `}else if(c==="language"){window.changeLanguage=$=>{p.user.language=$,z(),location.reload()};const h=p.user.language||"tr";r.innerHTML=`
                     <div class="space-y-3">
                        <!-- English -->
                         <div onclick="changeLanguage('en')" class="flex items-center justify-between p-3 border rounded-xl cursor-pointer transition-all ${h==="en"?"bg-primary/5 border-primary/20 shadow-sm":"bg-white border-gray-200 hover:bg-gray-50"}">
                            ...
                            <div class="w-4 h-4 rounded-full flex items-center justify-center ${h==="en"?"bg-primary":"border border-gray-300"}">
                                ${h==="en"?'<svg class="w-2.5 h-2.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>':""}
                            </div>
                        </div>

                        <!-- Turkish -->
                        <div onclick="changeLanguage('tr')" class="flex items-center justify-between p-3 border rounded-xl cursor-pointer transition-all ${h==="tr"?"bg-primary/5 border-primary/20 shadow-sm":"bg-white border-gray-200 hover:bg-gray-50"}">
                            <div class="flex items-center gap-3">
                                <div>
                            ...
                            <div class="w-4 h-4 rounded-full flex items-center justify-center ${h==="tr"?"bg-primary":"border border-gray-300"}">
                                ${h==="tr"?'<svg class="w-2.5 h-2.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>':""}
                            </div>
                        </div>
                ...
                `}else if(c==="profile"){const h=["🎓","🚀","⭐","🧠","🦁","⚡"];r.innerHTML=`
                <div class="space-y-6">
                    <!-- Avatar Selection -->
            ...
            `:c==="developer"&&(n?r.innerHTML=`
                ...
                `,setTimeout(()=>{const h=document.getElementById("dev-pin-input");h&&h.focus()},100)))};t.innerHTML=`
    <!-- Header -->
    <header class="sticky top-0 z-30 bg-white/80 md:bg-transparent backdrop-blur-xl px-4 md:px-8 pt-4 md:pt-8 pb-3 md:pb-4 flex flex-row flex-wrap md:flex-nowrap justify-between items-center mb-2 md:mb-4 gap-3 md:gap-4 border-b md:border-b-0 border-gray-100 transition-all">
      ...
      <div class="flex-1 min-w-[200px]">
        <h1 id="header-greeting" class="text-2xl md:text-3xl font-bold text-dark truncate">${e("hello")}, ${p.user.name}!</h1>
      ...
      <div class="flex items-center gap-2 md:gap-4 shrink-0">
        ...
        <button onclick="window.logout()" class="lg:hidden w-10 h-10 flex items-center justify-center bg-white text-gray-400 rounded-full hover:bg-red-50 hover:text-red-500 transition-colors border border-gray-100 shadow-sm" title="${e("logout")}">
             <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
        </button>
  ...
  `;const m=ue(p.stats),w=document.createElement("div");w.innerHTML=m;const L=Array.from(w.children);if(L&&L.length>=4){const r=t.querySelector("#dashboard-grid");r.innerHTML="",r.appendChild(L[0]),r.appendChild(L[1]),r.appendChild(L[2]);const b=document.createElement("div");b.id="profile-container",b.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",b.draggable=!0,r.appendChild(b);const h=document.createElement("div");h.id="chart-container",h.className="col-span-1 md:col-span-2 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",h.draggable=!0,r.appendChild(h);const $=document.createElement("div");$.id="time-container",$.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",$.draggable=!0,r.appendChild($);const g=document.createElement("div");g.id="notes-container",g.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",g.draggable=!0,r.appendChild(g);const y=document.createElement("div");y.id="pomodoro-container",y.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",y.draggable=!0,r.appendChild(y),r.appendChild(L[3]);const k=document.createElement("div");k.id="todo-container",k.className="col-span-1 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",k.draggable=!0,k.innerHTML='<div id="todo-content" class="w-full h-full"></div>',r.appendChild(k);const H=document.createElement("div");H.id="exam-schedule-container",H.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",H.draggable=!0,r.appendChild(H);const D=document.createElement("div");D.id="scratchpad-container",D.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",D.draggable=!0,r.appendChild(D);const q=document.createElement("div");q.id="bookmarks-container",q.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",q.draggable=!0,r.appendChild(q);const I=document.createElement("div");I.id="grade-calc-container",I.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",I.draggable=!0,r.appendChild(I);const C=document.createElement("div");C.id="stopwatch-container",C.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",C.draggable=!0,r.appendChild(C);const T=document.createElement("div");T.id="games-container",T.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",T.draggable=!0,r.appendChild(T);const A=document.createElement("div");A.id="habit-container",A.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",A.draggable=!0,r.appendChild(A);const V=document.createElement("div");V.id="weekly-schedule-container",V.className="col-span-1 md:col-span-2 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",V.draggable=!0,r.appendChild(V);const R=document.createElement("div");R.id="photo-container",R.className="col-span-1 h-80 bg-white rounded-3xl shadow-sm draggable-item relative group transition-all duration-300 ease-in-out",R.draggable=!0,r.appendChild(R)}Z(document.querySelector("#chart-container"),p.chartData),ve(document.querySelector("#time-container")),ge(document.querySelector("#notes-container")),he(document.querySelector("#pomodoro-container")),ae(document.querySelector("#exam-schedule-container"),p.todos,p.exams),Q(document.querySelector("#profile-container"),p.user),be(document.querySelector("#scratchpad-container")),fe(document.querySelector("#bookmarks-container")),ye(document.querySelector("#grade-calc-container")),xe(document.querySelector("#stopwatch-container")),we(document.querySelector("#games-container")),ke(document.querySelector("#habit-container")),ie(document.querySelector("#weekly-schedule-container")),U(document.querySelector("#photo-container")),a();const x=document.getElementById("weekly-schedule-container");x&&x.classList.contains("h-96")&&(x.classList.remove("h-96"),x.classList.add("h-80")),o();const f=document.getElementById("dashboard-grid");f.querySelectorAll(".draggable-item").forEach(s),f.addEventListener("dragover",r=>{r.preventDefault(),r.dataTransfer.dropEffect="move";const b=t,h=100,$=15;if(b){const g=b.getBoundingClientRect();r.clientY<g.top+h?b.scrollTop-=$:r.clientY>g.bottom-h&&(b.scrollTop+=$)}}),f.addEventListener("drop",r=>{if(r.preventDefault(),i&&i.dataset&&i.dataset.widgetId){const b=i.dataset.widgetId,h=l.get(b);if(h){f.appendChild(h),l.delete(b),s(h),v();const $=document.getElementById("manage-widgets-popup");$&&$.classList.add("invisible","opacity-0","scale-95")}return}i&&!i.dataset.widgetId&&f.contains(i)&&(f.appendChild(i),v())}),window.manualSaveLayout=()=>{v();const r=document.getElementById("settings-save-icon");if(r){const b=r.innerHTML;r.classList.add("text-primary"),r.classList.remove("text-gray-400"),r.innerHTML='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />',setTimeout(()=>{r.classList.add("text-gray-400"),r.classList.remove("text-primary"),r.innerHTML=b},1e3)}},window.confirmResetLayout=()=>{const r=document.createElement("div");r.className="fixed inset-0 z-[60] flex items-center justify-center bg-dark/50 backdrop-blur-sm opacity-0 transition-opacity duration-300 px-4",r.innerHTML=`
        ...
        `,document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.remove("opacity-0"),r.querySelector("div").classList.remove("scale-95"),r.querySelector("div").classList.add("scale-100")});const b=()=>{r.classList.add("opacity-0"),r.querySelector("div").classList.remove("scale-100"),r.querySelector("div").classList.add("scale-95"),setTimeout(()=>r.remove(),300)};r.querySelector("#cancel-reset-layout").onclick=b,r.onclick=h=>{h.target===r&&b()},r.querySelector("#confirm-reset-layout-btn").onclick=()=>{localStorage.removeItem("dashboardLayout"),location.reload()}},document.getElementById("edit-widgets-modal")&&document.getElementById("edit-widgets-modal").remove(),setTimeout(()=>{const r=document.getElementById("manage-widgets-dropzone");r&&(r.addEventListener("dragover",b=>{b.preventDefault(),b.dataTransfer.dropEffect="move",r.classList.remove("border-primary/20","bg-primary/5"),r.classList.add("border-primary/50","bg-primary/10")}),r.addEventListener("dragleave",()=>{r.classList.add("border-primary/20","bg-primary/5"),r.classList.remove("border-primary/50","bg-primary/10")}),r.addEventListener("drop",b=>{if(b.preventDefault(),r.classList.add("border-primary/20","bg-primary/5"),r.classList.remove("border-primary/50","bg-primary/10"),i&&!i.dataset.widgetId&&i.classList.contains("draggable-item")){const h=i.id;l.set(h,i),i.remove(),v(),window.toggleManageDropdown(),window.toggleManageDropdown()}}))},500);const S=document.querySelector("#todo-content"),_=(r=null,b=null)=>{S&&pe(S,p.todos,r,b)};window.dashboardHandlersInitialized||(window.addNewTodo=()=>{},window.toggleTodo=r=>{p.todos[r]&&(p.todos[r].completed=!p.todos[r].completed,document.dispatchEvent(new Event("dataChanged")))},window.editTodo=r=>_(r,null),window.saveEditTodo=r=>{const b=document.getElementById(`edit-title-${r}`),h=document.getElementById(`edit-date-${r}`),$=document.getElementById(`edit-time-${r}`);b&&p.todos[r]&&(p.todos[r].title=b.value||p.todos[r].title,p.todos[r].date=h.value||null,p.todos[r].time=$.value||"",document.dispatchEvent(new Event("dataChanged")),_(null,null))},window.cancelEditTodo=()=>_(null,null),window.deleteTodo=r=>_(null,r),window.confirmDeleteTodo=r=>{p.todos.splice(r,1),document.dispatchEvent(new Event("dataChanged"))},window.cancelDeleteTodo=()=>_(null,null),window.addSpecificTodo=r=>{if(r){const b=new Date,h=`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}-${String(b.getDate()).padStart(2,"0")}`;p.todos.push({title:r,subject:"General",time:"09:00",completed:!1,date:h}),document.dispatchEvent(new Event("dataChanged"))}},window.dashboardHandlersInitialized=!0),_();const B=()=>{const r=p.todos?p.todos.filter(y=>y.completed).length:0,b=JSON.parse(localStorage.getItem("habit_tracker_data_v3")||"{}"),h=b.habits?b.habits.filter(y=>y.completed).length:0,$=r+h,g=document.getElementById("stats-card-1");if(g){const y=g.querySelector(".text-3xl");y&&(y.innerText=$);const k=document.getElementById("stat-todo-count");k&&(k.innerText=r);const H=document.getElementById("stat-habit-count");H&&(H.innerText=h)}},j=()=>{_(null,null),ae(document.querySelector("#exam-schedule-container"),p.todos,p.exams),o(),B()};document.removeEventListener("dataChanged",j),document.addEventListener("dataChanged",j);const E=()=>{const r=document.getElementById("header-greeting");r&&(r.innerText=`${e("hello")}, ${p.user.name}!`)};document.removeEventListener("profileUpdated",E),document.addEventListener("profileUpdated",E),window.aiCoachInitialized||(window.openAiCoach=()=>{let r=document.getElementById("ai-coach-modal");r||(document.body.insertAdjacentHTML("beforeend",`
                ...
                </div>`),r=document.getElementById("ai-coach-modal")),r.classList.remove("invisible","opacity-0");const b=r.querySelector("#ai-coach-card");b.classList.remove("scale-95"),b.classList.add("scale-100"),setTimeout(()=>document.getElementById("ai-chat-input").focus(),100)},window.closeAiCoach=()=>{const r=document.getElementById("ai-coach-modal");if(r){r.classList.add("invisible","opacity-0");const b=r.querySelector("#ai-coach-card");b.classList.add("scale-95"),b.classList.remove("scale-100")}},window.sendAiMessage=()=>{const r=document.getElementById("ai-chat-input"),b=document.getElementById("ai-chat-messages"),h=r.value.trim();if(h){const $=`
                ...
                `;b.insertAdjacentHTML("beforeend",$),r.value="",b.scrollTop=b.scrollHeight,setTimeout(()=>{let g="That is a great question. I am currently in demo mode, but imagine I just gave you a brilliant, personalized answer to help you ace your exams.";h.toLowerCase().includes("schedule")||h.toLowerCase().includes("plan")?g="I can help you organize that. Let us break it down into smaller tasks. Check your Todo List and try to allocate 25-minute focus blocks for each.":h.toLowerCase().includes("motivat")?g="You got this. Remember why you started. Every small step counts. Take a deep breath and crush it.":h.toLowerCase().includes("help")&&(g="I am here for you. Try asking me about a specific subject, or tell me what you are struggling with.");const y=`
                     ...
                     `;b.insertAdjacentHTML("beforeend",y),b.scrollTop=b.scrollHeight},1e3)}},window.aiCoachInitialized=!0),setTimeout(()=>{const r=document.getElementById("calc-display"),b=document.querySelectorAll(".calc-btn");r&&b.length>0&&b.forEach(h=>{h.addEventListener("click",$=>{const g=h.getAttribute("data-val");if($.stopPropagation(),g==="C")r.value="0";else if(g==="=")try{const y=r.value.replace(/×/g,"*").replace(/÷/g,"/");if(!/^[\d+\-*/().%\s]+$/.test(y))throw new Error("Invalid characters");const H=(D=>{const I=D.replace(/\s/g,"").replace(/(\d+(?:\.\d+)?)%/g,"($1/100)"),T=new Function("return "+I)();if(!isFinite(T))throw new Error("Invalid result");return T})(y);r.value=Number.isInteger(H)?H:parseFloat(H.toFixed(8))}catch{r.value="Error"}else r.value==="0"||r.value==="Error"?r.value=g:r.value+=g}),h.setAttribute("draggable","true"),h.addEventListener("dragstart",$=>{$.preventDefault(),$.stopPropagation()}),h.addEventListener("mousedown",$=>{$.stopPropagation()})})},500)}function Le(t,n){let o=1,i="🎓",l="emerald",d="default",v=160,a=84,s=39;const c=x=>{const f=u[x];if(f){const[M,S,_]=f.split(" ").map(Number),[B,j,E]=Se(M,S,_);v=B,a=j,s=E}},u={emerald:"5 150 105",blue:"37 99 235",pink:"236 72 153",orange:"234 88 12",rose:"225 29 72",lila:"178 106 251"};c(l),document.documentElement.style.setProperty("--color-primary-rgb",u[l]);const m=()=>{t.innerHTML=`
                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <button class="bg-pref-btn group relative p-3 rounded-2xl border-2 transition-all text-left flex flex-col gap-2 ${d==="default"?"border-primary bg-primary/5 ring-1 ring-primary":"border-gray-100 bg-white hover:border-gray-200"}" data-bg="default">
                                        ...
                                        ${d==="default"?'<div class="absolute top-3 right-3 text-primary"><svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg></div>':""}
                                    </button>

                                    <button class="bg-pref-btn group relative p-3 rounded-2xl border-2 transition-all text-left flex flex-col gap-2 ${d==="theme"?"border-primary bg-primary/5 ring-1 ring-primary":"border-gray-100 bg-white hover:border-gray-200"}" data-bg="theme">
                                        ...
                                        ${d==="theme"?'<div class="absolute top-3 right-3 text-primary"><svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg></div>':""}
                                    </button>
                                </div>
                            </div>
        ...
        `,w()},w=()=>{t.querySelectorAll(".avatar-btn").forEach(B=>{B.addEventListener("click",()=>{i=B.dataset.avatar,m(),o===1&&setTimeout(()=>document.getElementById("input-name").focus(),50)})}),t.querySelectorAll(".theme-btn").forEach(B=>{B.addEventListener("click",()=>{l=B.dataset.theme,c(l);const j=se(v,a,s).join(" ");document.documentElement.style.setProperty("--color-primary-rgb",j),m()})}),t.querySelectorAll(".bg-pref-btn").forEach(B=>{B.addEventListener("click",()=>{d=B.dataset.bg,d==="theme"?document.body.style.backgroundColor="rgb(var(--color-primary-rgb) / 0.04)":document.body.style.backgroundColor="",m()})});const x=t.querySelector("#btn-next"),f=t.querySelector("#btn-back"),M=document.getElementById("input-name"),S=document.getElementById("input-university"),_=document.getElementById("input-dept");M&&M.addEventListener("input",B=>p.user.name=B.target.value),S&&S.addEventListener("input",B=>p.user.university=B.target.value),_&&_.addEventListener("input",B=>p.user.department=B.target.value),x.addEventListener("click",()=>{if(o===1&&(!p.user.name||!p.user.name.trim())){document.getElementById("input-name").classList.add("ring-2","ring-red-500","border-red-500");return}if(o===2){if(!p.user.university||!p.user.university.trim()){document.getElementById("input-university").classList.add("ring-2","ring-red-500","border-red-500");return}if(!p.user.department||!p.user.department.trim()){document.getElementById("input-dept").classList.add("ring-2","ring-red-500","border-red-500");return}}o<3?(o++,m()):L()}),f.addEventListener("click",()=>{o>1&&(o--,m())})},L=()=>{p.user.avatar=i,p.user.isSetup=!0,p.user.themePreference=l;const[x,f,M]=se(v,a,s);p.user.customThemeRgb=`${x} ${f} ${M}`,p.user.bgPreference=d,z();const S=t.querySelector(".fixed");t.querySelector(".relative").classList.add("scale-95","opacity-0","-translate-y-4"),S.classList.add("opacity-0"),setTimeout(()=>{t.innerHTML="",n()},500)};m()}function Se(t,n,o){t/=255,n/=255,o/=255;const i=Math.max(t,n,o),l=Math.min(t,n,o);let d,v,a=(i+l)/2;if(i===l)d=v=0;else{const s=i-l;switch(v=a>.5?s/(2-i-l):s/(i+l),i){case t:d=(n-o)/s+(n<o?6:0);break;case n:d=(o-t)/s+2;break;case o:d=(t-n)/s+4;break}d/=6}return[d*360,v*100,a*100]}function se(t,n,o){t/=360,n/=100,o/=100;let i,l,d;if(n===0)i=l=d=o;else{const v=(c,u,m)=>(m<0&&(m+=1),m>1&&(m-=1),m<.16666666666666666?c+(u-c)*6*m:m<.5?u:m<.6666666666666666?c+(u-c)*(.6666666666666666-m)*6:c),a=o<.5?o*(1+n):o+n-o*n,s=2*o-a;i=v(s,a,t+1/3),l=v(s,a,t),d=v(s,a,t-1/3)}return[Math.round(i*255),Math.round(l*255),Math.round(d*255)]}function $e(t){p.courses||(p.courses=[],z());let n=null;const o=()=>{const a=document.getElementById("courses-grid").querySelector(".grid");if(!a)return;const c=Array.from(a.children).map(u=>u.getAttribute("data-course-id"));localStorage.setItem("coursesLayout",JSON.stringify(c))},i=()=>{const a=localStorage.getItem("coursesLayout");if(!a)return p.courses;try{const s=JSON.parse(a).map(m=>parseInt(m)),c=new Map(p.courses.map(m=>[m.id,m])),u=[];return s.forEach(m=>{c.has(m)&&(u.push(c.get(m)),c.delete(m))}),c.forEach(m=>u.push(m)),u}catch(s){return console.error("Failed to parse course layout",s),p.courses}},l=a=>{const s=document.getElementById("courses-grid").querySelector(".grid");a.addEventListener("dragstart",c=>{n=a,c.dataTransfer.effectAllowed="move",c.dataTransfer.setData("text/plain",a.id),requestAnimationFrame(()=>{a.classList.add("opacity-50","scale-95")})}),a.addEventListener("dragend",()=>{a.classList.remove("opacity-50","scale-95"),n=null,s&&s.querySelectorAll(".draggable-item").forEach(c=>{c.classList.remove("ring-2","ring-primary","ring-offset-2","z-30"),c.classList.remove("ring-2","ring-primary")})}),a.addEventListener("dragover",c=>{c.preventDefault(),n&&n!==a&&a.classList.add("ring-2","ring-primary","z-30")}),a.addEventListener("dragleave",c=>{a.contains(c.relatedTarget)||a.classList.remove("ring-2","ring-primary","z-30")}),a.addEventListener("drop",c=>{if(c.preventDefault(),c.stopPropagation(),a.classList.remove("ring-2","ring-primary","z-30"),n&&n!==a){const u=s,m=Array.from(u.children),w=m.indexOf(n),L=m.indexOf(a);w<L?u.insertBefore(n,a.nextSibling):u.insertBefore(n,a),o()}})},d=()=>{const a=i();t.innerHTML=`
                            ...
                            >
                                ...
                                <!-- Body -->
                                    ...
                                    <div class="flex items-center gap-2 mb-1">
                                        ${s.code?`<span class="px-2.5 py-0.5 rounded-md bg-gray-50 text-gray-400 text-[10px] font-bold tracking-wider uppercase border border-gray-100">${s.code}</span>`:""}
                                        <span class="h-1 w-1 rounded-full bg-gray-300"></span>
                                        <span class="text-[10px] font-bold text-gray-300 uppercase tracking-widest">${e("course_caps")}</span>
                                    </div>
                                    
                                    <h3 class="text-xl font-bold text-dark truncate leading-tight mb-2" title="${s.name}">${s.name}</h3>
                                    ...
                                    <div class="mt-auto flex items-center justify-between pt-3 border-t border-gray-50/50">
                                        <div class="text-xs text-gray-400 line-clamp-1 max-w-[60%]">
                                            ${s.note||`<span class="opacity-50 italic">${e("no_details")}</span>`}
                                        </div>
        ...
        `,v(),t.querySelectorAll(".draggable-item").forEach(l)},v=()=>{const a=t.querySelector("#add-course-modal"),s=a.querySelector("div"),c=t.querySelector("#add-course-btn"),u=t.querySelector("#close-modal-btn"),m=t.querySelector("#step-1"),w=t.querySelector("#step-2"),L=t.querySelector("#next-step-btn"),x=t.querySelector("#prev-step-btn"),f=t.querySelector("#finish-step-btn"),M=t.querySelector("#wizard-step-indicator"),S=t.querySelector("#wizard-progress"),_=t.querySelector("#course-name-input"),B=t.querySelector("#course-code-input"),j=t.querySelector("#course-instructor-input"),E=t.querySelector("#course-email-input"),r=t.querySelector("#course-schedule-input"),b=t.querySelector("#course-location-input"),h=t.querySelector("#course-note-input");let $="blue",g=null;const y=t.querySelector("#modal-title"),k=()=>{m.classList.remove("hidden"),w.classList.add("hidden"),x.classList.add("hidden"),L.classList.remove("hidden"),f.classList.add("hidden"),M.textContent=e("step_1_basic"),S.style.width="50%",_.value="",B&&(B.value=""),j&&(j.value=""),E&&(E.value=""),r&&(r.value=""),b&&(b.value=""),h&&(h.value=""),_.classList.remove("ring-2","ring-red-500/50","border-red-500"),$="blue"},H=()=>{g=null,y&&(y.textContent=e("new_course_setup")),f&&(f.textContent=e("create_course")),k(),a.classList.remove("invisible","opacity-0"),a.classList.add("visible","opacity-100"),s.classList.remove("scale-95"),s.classList.add("scale-100"),setTimeout(()=>_.focus(),100)},D=N=>{const P=p.courses.find(G=>G.id===N);P&&(g=N,y&&(y.textContent=e("edit_course_setup")),f&&(f.textContent=e("save")),k(),_.value=P.name,B&&(B.value=P.code||""),j&&(j.value=P.instructor||""),E&&(E.value=P.email||""),r&&(r.value=P.schedule||""),b&&(b.value=P.location||""),h&&(h.value=P.note||""),$=P.color||"blue",a.classList.remove("invisible","opacity-0"),a.classList.add("visible","opacity-100"),s.classList.remove("scale-95"),s.classList.add("scale-100"))},q=()=>{a.classList.add("invisible","opacity-0"),a.classList.remove("visible","opacity-100"),s.classList.add("scale-95"),s.classList.remove("scale-100")};c.addEventListener("click",H),u.addEventListener("click",q),L.addEventListener("click",()=>{if(!_.value.trim()){_.classList.add("ring-2","ring-red-500/50","border-red-500"),_.focus();return}_.classList.remove("ring-2","ring-red-500/50","border-red-500"),m.classList.add("hidden"),w.classList.remove("hidden"),x.classList.remove("hidden"),L.classList.add("hidden"),f.classList.remove("hidden"),M.textContent=e("step_2_logistics"),S.style.width="100%"}),x.addEventListener("click",()=>{m.classList.remove("hidden"),w.classList.add("hidden"),x.classList.add("hidden"),L.classList.remove("hidden"),f.classList.add("hidden"),M.textContent=e("step_1_basic"),S.style.width="50%"}),f.addEventListener("click",()=>{const N=_.value.trim(),P=B?B.value.trim():"",G=j?j.value.trim():"",X=E?E.value.trim():"",ee=r?r.value.trim():"",te=b?b.value.trim():"",re=h?h.value.trim():"";if(g){const F=p.courses.find(le=>le.id===g);F&&(F.name=N,F.code=P,F.instructor=G,F.email=X,F.schedule=ee,F.location=te,F.note=re,F.color=$)}else{const F={id:Date.now(),name:N,code:P,color:$,instructor:G,email:X,schedule:ee,location:te,note:re,resources:[],aiSessions:[]};F.aiSessions.push({id:Date.now(),title:"General Chat",messages:[{sender:"ai",text:`Hi! I'm StudyAl, your personal AI assistant for **${N}**. Ask me anything about the course materials, exams, or topics!`}],timestamp:Date.now()}),F.currentSessionId=F.aiSessions[0].id,p.courses.push(F),p.stats.courses.total=p.courses.length}z(),q(),d()});const I=t.querySelector("#delete-course-modal"),C=I.querySelector("div"),T=t.querySelector("#cancel-delete-btn"),A=t.querySelector("#confirm-delete-btn");let V=null;const R=()=>{I.classList.add("invisible","opacity-0"),I.classList.remove("visible","opacity-100"),C.classList.add("scale-95"),C.classList.remove("scale-100"),V=null},W=N=>{V=N,I.classList.remove("invisible","opacity-0"),I.classList.add("visible","opacity-100"),C.classList.remove("scale-95"),C.classList.add("scale-100")};t.querySelectorAll(".delete-course-btn").forEach(N=>{N.addEventListener("click",P=>{P.stopPropagation(),W(parseInt(N.dataset.id))})}),t.querySelectorAll(".edit-course-btn").forEach(N=>{N.addEventListener("click",P=>{P.stopPropagation(),D(parseInt(N.dataset.id))})}),T.addEventListener("click",R),A.addEventListener("click",()=>{if(V){p.courses=p.courses.filter(P=>P.id!==V),p.stats.courses.total=p.courses.length,z();const N=localStorage.getItem("coursesLayout");if(N){let P=JSON.parse(N);P=P.filter(G=>parseInt(G)!==V),localStorage.setItem("coursesLayout",JSON.stringify(P))}R(),d()}}),_.addEventListener("input",()=>{_.classList.remove("ring-2","ring-red-500/50","border-red-500")})};d()}const Me=t=>(t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/\*(.*?)\*/g,"<em>$1</em>"),t);function Ce(t,n){const o=p.courses.find(d=>d.id===n);if(!o){t.innerHTML=`
        ...
        `;return}if(o.resources||(o.resources=[],z()),o.instructor===void 0&&(o.instructor=""),o.email===void 0&&(o.email=""),o.location===void 0&&(o.location=""),o.schedule===void 0&&(o.schedule=""),!o.aiSessions){const d=o.chatHistory||[{sender:"ai",text:`Hi! I'm StudyAl, your personal AI assistant for **${o.name}**. Ask me anything about the course materials, exams, or topics!`}];o.aiSessions=[{id:Date.now(),title:"General Chat",messages:d,timestamp:Date.now()}],o.currentSessionId=o.aiSessions[0].id,delete o.chatHistory,z()}const i=()=>{const d=o.aiSessions.find(v=>v.id===o.currentSessionId)||o.aiSessions[0];if(!d){o.currentSessionId=o.aiSessions[0].id,z(),i();return}t.innerHTML=`
                                    ...
                                    ${o.resources.map(v=>`
                                        <li class="flex items-center justify-between p-3 bg-gray-50 rounded-xl group hover:bg-gray-100 transition-colors">
                                            <div class="flex items-center gap-3 min-w-0 flex-1">
                                                ...
                                                <div class="truncate">
                                                    <p class="text-sm font-bold text-dark truncate">${v.name}</p>
                                                    <p class="text-xs text-gray-400 truncate">${v.type||e("unknown_type")}</p>
                                                </div>
                                            </div>
                                             <button class="delete-resource-btn text-gray-300 hover:text-primary p-1 transition-colors opacity-0 group-hover:opacity-100" data-id="${v.id}">
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                                            </button>
                                        </li>
                                    `).join("")}
                    ...
                    <!-- StudyAl AI Assistant -->
                     <div class="border border-gray-100 rounded-2xl p-6 flex flex-col h-[500px] bg-gradient-to-br from-primary/5 via-white to-primary/10 relative overflow-hidden">
                         ...
                         <div id="chat-messages" class="flex-1 overflow-y-auto custom-scrollbar space-y-4 mb-4 pr-2 z-10 transition-all">
                             ${d.messages.map(v=>`
                                 <div class="flex ${v.sender==="user"?"justify-end":"justify-start"}">
                                     <div class="max-w-[85%] ${v.sender==="user"?"bg-primary text-white rounded-t-2xl rounded-bl-2xl shadow-lg shadow-primary/20":"bg-white border border-gray-100 text-gray-700 rounded-t-2xl rounded-br-2xl shadow-sm"} px-4 py-3 text-sm leading-relaxed">
                                         ${v.sender==="ai"?Me(v.text):v.text}
                                     </div>
                                 </div>
                             `).join("")}
                         </div>
                        ...
                        <div id="history-sidebar" class="absolute inset-y-0 left-0 w-64 bg-white shadow-xl border-r border-gray-100 transform -translate-x-full transition-transform duration-300 z-40 p-4 flex flex-col">
                            ...
                            <div class="flex-1 overflow-y-auto custom-scrollbar space-y-2">
                                ${o.aiSessions.sort((v,a)=>a.timestamp-v.timestamp).map(v=>`
                                    <button class="history-item-btn w-full text-left p-3 rounded-xl text-xs transition-colors group relative ${v.id===o.currentSessionId?"bg-primary/10 text-primary font-bold":"hover:bg-gray-50 text-gray-500"}" data-id="${v.id}">
                                        <p class="truncate pr-6">${v.title}</p>
                                        <span class="text-[10px] opacity-60 block mt-1">${new Date(v.timestamp).toLocaleDateString()}</span>
                                        ${o.aiSessions.length>1?`
                                            <div class="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                 <span class="delete-session-btn block p-1 hover:text-primary cursor-pointer" data-id="${v.id}">
        ...
        `,l()},l=()=>{const d=t.querySelector("#chat-form"),v=t.querySelector("#chat-input"),a=t.querySelector("#chat-messages"),s=t.querySelector("#edit-info-modal");if(s){const j=s.querySelector("div"),E=t.querySelector("#edit-info-btn"),r=t.querySelector("#close-edit-info-btn"),b=t.querySelector("#save-info-btn"),h=t.querySelector("#info-instructor"),$=t.querySelector("#info-email"),g=t.querySelector("#info-schedule"),y=t.querySelector("#info-location");E&&E.addEventListener("click",()=>{s.classList.remove("invisible","opacity-0"),s.classList.add("visible","opacity-100"),j.classList.remove("scale-95"),j.classList.add("scale-100")});const k=()=>{s.classList.add("invisible","opacity-0"),s.classList.remove("visible","opacity-100"),j.classList.add("scale-95"),j.classList.remove("scale-100")};r&&r.addEventListener("click",k),b&&b.addEventListener("click",()=>{o.instructor=h.value.trim(),o.email=$.value.trim(),o.schedule=g.value.trim(),o.location=y.value.trim(),z(),k(),i()})}if(a&&(a.scrollTop=a.scrollHeight),d){d.addEventListener("submit",async q=>{q.preventDefault();const I=v.value.trim();if(!I)return;const C=o.aiSessions.find(T=>T.id===o.currentSessionId);C&&(C.messages.push({sender:"user",text:I}),C.messages.length===2&&(C.title=I.length>25?I.substring(0,25)+"...":I),C.timestamp=Date.now(),z(),i(),setTimeout(()=>{const T=["That's a great question! Based on typical course structures, you should focus on the core principles first.","I can certainly help with that. Could you provide a bit more context from your lecture notes?","Interesting point. This topic often relates to the previous module about fundamentals.","Here's a quick summary: The concept basically explains the relationship between variables in this context.",`Since this is **${o.name}**, remember to review the recommended readings for this week.`],A=T[Math.floor(Math.random()*T.length)];C.messages.push({sender:"ai",text:A}),C.timestamp=Date.now(),z(),i()},1500))});const j=t.querySelector("#new-chat-btn");j&&j.addEventListener("click",()=>{const q={id:Date.now(),title:e("new_conversation"),messages:[{sender:"ai",text:`Hi! I'm StudyAl. Start a new topic for **${o.name}**!`}],timestamp:Date.now()};o.aiSessions.push(q),o.currentSessionId=q.id,z(),i()});const E=t.querySelector("#history-toggle-btn"),r=t.querySelector("#history-sidebar"),b=t.querySelector("#close-history-btn");E&&r&&E.addEventListener("click",()=>{r.classList.remove("-translate-x-full")}),b&&r&&b.addEventListener("click",()=>{r.classList.add("-translate-x-full")});const h=t.querySelector("#delete-session-modal"),$=h.querySelector("div"),g=t.querySelector("#cancel-delete-session-btn"),y=t.querySelector("#confirm-delete-session-btn");let k=null;const H=q=>{k=q,h.classList.remove("invisible","opacity-0"),h.classList.add("visible","opacity-100"),$.classList.remove("scale-95"),$.classList.add("scale-100")},D=()=>{k=null,h.classList.add("invisible","opacity-0"),h.classList.remove("visible","opacity-100"),$.classList.add("scale-95"),$.classList.remove("scale-100")};r&&r.addEventListener("click",q=>{const I=q.target.closest(".delete-session-btn");if(I){q.stopPropagation();const T=parseInt(I.dataset.id);H(T);return}const C=q.target.closest(".history-item-btn");if(C){const T=parseInt(C.dataset.id);T!==o.currentSessionId?(o.currentSessionId=T,z(),i()):r.classList.add("-translate-x-full")}}),g&&g.addEventListener("click",D),y&&y.addEventListener("click",()=>{var q;if(k){if(o.aiSessions=o.aiSessions.filter(I=>I.id!==k),k===o.currentSessionId&&(o.currentSessionId=((q=o.aiSessions[0])==null?void 0:q.id)||null,!o.aiSessions.length)){const I=[{sender:"ai",text:`Hi! I'm StudyAl, your personal AI assistant for **${o.name}**. Ask me anything about the course materials, exams, or topics!`}],C={id:Date.now(),title:"General Chat",messages:I,timestamp:Date.now()};o.aiSessions.push(C),o.currentSessionId=C.id}z(),D(),i()}}),t.querySelector("#clear-chat-modal")}const c=t.querySelector("#add-resource-btn"),u=t.querySelector("#file-upload-input"),m=t.querySelector("#delete-resource-modal"),w=m.querySelector("div"),L=t.querySelector("#cancel-delete-res-btn"),x=t.querySelector("#confirm-delete-res-btn");let f=null;const M=j=>{f=j,m.classList.remove("invisible","opacity-0"),m.classList.add("visible","opacity-100"),w.classList.remove("scale-95"),w.classList.add("scale-100")},S=()=>{f=null,m.classList.add("invisible","opacity-0"),m.classList.remove("visible","opacity-100"),w.classList.add("scale-95"),w.classList.remove("scale-100")};c&&c.addEventListener("click",()=>{u.click()}),u&&u.addEventListener("change",j=>{const E=j.target.files[0];E&&(o.resources.push({id:Date.now(),name:E.name,type:E.type||"Unknown Type",size:(E.size/1024).toFixed(1)+" KB"}),z(),i())}),t.querySelectorAll(".delete-resource-btn").forEach(j=>{j.addEventListener("click",E=>{E.preventDefault(),M(parseInt(j.dataset.id))})}),L&&L.addEventListener("click",S),x&&x.addEventListener("click",()=>{f&&(o.resources=o.resources.filter(j=>j.id!==f),z(),i())});const _=t.querySelector("#delete-course-detail-btn"),B=t.querySelector("#delete-course-detail-modal");if(B){const j=B.querySelector("div"),E=t.querySelector("#cancel-delete-course-detail-btn"),r=t.querySelector("#confirm-delete-course-detail-btn");_&&_.addEventListener("click",()=>{B.classList.remove("invisible","opacity-0"),B.classList.add("visible","opacity-100"),j.classList.remove("scale-95"),j.classList.add("scale-100")});const b=()=>{B.classList.add("invisible","opacity-0"),B.classList.remove("visible","opacity-100"),j.classList.add("scale-95"),j.classList.remove("scale-100")};E&&E.addEventListener("click",b),r&&r.addEventListener("click",()=>{p.courses=p.courses.filter(h=>h.id!==o.id),p.stats.courses.total=p.courses.length,z(),window.navigateTo("courses")})}};i()}function je(t){if(!t)return;const n=()=>{const i=[...p.exams||[]].sort((l,d)=>new Date(l.date).getTime()-new Date(d.date).getTime());t.innerHTML=`
            <div class="p-4 md:p-8 h-full flex flex-col relative">
                ...
                <div class="flex-1 overflow-y-auto custom-scrollbar pr-2 pb-20 md:pb-0">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 content-start pb-10">
                        ${i.map(l=>{const d=new Date(l.date),a=d-new Date,s=Math.ceil(a/(1e3*60*60*24));let c="bg-primary/10 text-primary";s<3&&(c+=" animate-pulse");const u=d.toLocaleString("default",{month:"short"}).toUpperCase(),m=d.getDate(),w=d.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`
                            <div class="relative bg-white rounded-3xl drop-shadow-sm hover:drop-shadow-md transition-all group overflow-hidden flex h-32" 
                                ...
                                <div class="w-24 bg-primary/15 flex flex-col items-center justify-center p-3 border-r-2 border-dashed border-primary/30 shrink-0">
                                    ...
                                    <span class="text-3xl font-black text-primary leading-none">${m}</span>
        ...
        `,o()},o=()=>{const i=t.querySelector("#add-exam-modal"),l=i.querySelector("div"),d=t.querySelector("#add-exam-btn"),v=t.querySelector("#close-modal-btn"),a=t.querySelector("#step-1"),s=t.querySelector("#step-2"),c=t.querySelector("#next-step-btn"),u=t.querySelector("#prev-step-btn"),m=t.querySelector("#finish-step-btn"),w=t.querySelector("#wizard-step-indicator"),L=t.querySelector("#wizard-progress"),x=t.querySelector("#ex-name"),f=t.querySelector("#ex-code"),M=t.querySelector("#ex-type"),S=t.querySelector("#ex-date"),_=t.querySelector("#ex-time"),B=t.querySelector("#ex-loc");let j=null;const E=t.querySelector("#modal-title"),r=()=>{a.classList.remove("hidden"),s.classList.add("hidden"),u.classList.add("hidden"),c.classList.remove("hidden"),m.classList.add("hidden"),w.textContent=e("step_1_basic"),L.style.width="50%",x.value="",f.value="",S.value="",_.value="",B.value="",M.value="Midterm",[x,f,S,_].forEach(C=>C.classList.remove("ring-2","ring-red-500/50","border-red-500"))},b=()=>{j=null,E&&(E.textContent=e("new_exam_setup")),m&&(m.textContent=e("add_exam")),r(),i.classList.remove("invisible","opacity-0"),i.classList.add("visible","opacity-100"),l.classList.remove("scale-95"),l.classList.add("scale-100")},h=C=>{const T=p.exams.find(V=>V.id===C);if(!T)return;j=C,E&&(E.textContent=e("edit_exam_setup")),m&&(m.textContent=e("save")),r(),x.value=T.name,f.value=T.code,M.value=T.type,B.value=T.location||"";const A=new Date(T.date);if(!isNaN(A.getTime())){const V=A.getFullYear(),R=String(A.getMonth()+1).padStart(2,"0"),W=String(A.getDate()).padStart(2,"0");S.value=`${V}-${R}-${W}`;const N=String(A.getHours()).padStart(2,"0"),P=String(A.getMinutes()).padStart(2,"0");_.value=`${N}:${P}`}i.classList.remove("invisible","opacity-0"),i.classList.add("visible","opacity-100"),l.classList.remove("scale-95"),l.classList.add("scale-100")},$=()=>{i.classList.add("invisible","opacity-0"),i.classList.remove("visible","opacity-100"),l.classList.add("scale-95"),l.classList.remove("scale-100")};d.addEventListener("click",b),v.addEventListener("click",$),c.addEventListener("click",()=>{if(!x.value.trim()||!f.value.trim()){x.value.trim()||x.classList.add("ring-2","ring-red-500/50","border-red-500"),f.value.trim()||f.classList.add("ring-2","ring-red-500/50","border-red-500");return}x.classList.remove("ring-2","ring-red-500/50","border-red-500"),f.classList.remove("ring-2","ring-red-500/50","border-red-500"),a.classList.add("hidden"),s.classList.remove("hidden"),u.classList.remove("hidden"),c.classList.add("hidden"),m.classList.remove("hidden"),w.textContent=e("step_2_logistics"),L.style.width="100%"}),u.addEventListener("click",()=>{a.classList.remove("hidden"),s.classList.add("hidden"),u.classList.add("hidden"),c.classList.remove("hidden"),m.classList.add("hidden"),w.textContent=e("step_1_basic"),L.style.width="50%"}),m.addEventListener("click",()=>{if(!S.value||!_.value){S.value||S.classList.add("ring-2","ring-red-500/50","border-red-500"),_.value||_.classList.add("ring-2","ring-red-500/50","border-red-500");return}const C=new Date(`${S.value}T${_.value}`);if(j){const T=p.exams.find(A=>A.id===j);T&&(T.code=f.value.trim(),T.name=x.value.trim(),T.type=M.value,T.location=B.value.trim()||"TBD",T.date=C.toISOString())}else{const T={id:Date.now(),code:f.value.trim(),name:x.value.trim(),type:M.value,location:B.value.trim()||"TBD",date:C.toISOString()};p.exams||(p.exams=[]),p.exams.push(T)}z(),$(),n()});const g=t.querySelector("#delete-exam-modal"),y=g.querySelector("div"),k=t.querySelector("#cancel-delete-btn"),H=t.querySelector("#confirm-delete-btn");let D=null;const q=()=>{g.classList.add("invisible","opacity-0"),g.classList.remove("visible","opacity-100"),y.classList.add("scale-95"),y.classList.remove("scale-100"),D=null},I=C=>{D=C,g.classList.remove("invisible","opacity-0"),g.classList.add("visible","opacity-100"),y.classList.remove("scale-95"),y.classList.add("scale-100")};t.addEventListener("click",C=>{if(C.target.closest(".delete-exam-btn")){const T=C.target.closest(".delete-exam-btn");I(parseInt(T.dataset.id))}if(C.target.closest(".edit-exam-btn")){const T=C.target.closest(".edit-exam-btn");h(parseInt(T.dataset.id))}}),k.addEventListener("click",q),H.addEventListener("click",()=>{if(D){const C=p.exams.findIndex(T=>T.id===D);C!==-1&&(p.exams.splice(C,1),z(),q(),n())}}),[x,f,S,_].forEach(C=>{C.addEventListener("input",()=>{C.classList.remove("ring-2","ring-red-500/50","border-red-500")})})};n()}function Be(t){p.cheatsheets||(p.cheatsheets=[],z());let n=null;const o=()=>{const a=document.getElementById("sheets-grid").querySelector(".grid");if(!a)return;const c=Array.from(a.children).map(u=>u.getAttribute("data-sheet-id"));localStorage.setItem("cheatsheetsLayout",JSON.stringify(c))},i=()=>{const a=localStorage.getItem("cheatsheetsLayout");if(!a)return p.cheatsheets;try{const s=JSON.parse(a).map(m=>parseInt(m)),c=new Map(p.cheatsheets.map(m=>[m.id,m])),u=[];return s.forEach(m=>{c.has(m)&&(u.push(c.get(m)),c.delete(m))}),c.forEach(m=>u.push(m)),u}catch(s){return console.error("Failed to parse layout",s),p.cheatsheets}},l=a=>{const s=document.getElementById("sheets-grid").querySelector(".grid");a.addEventListener("dragstart",c=>{n=a,c.dataTransfer.effectAllowed="move",c.dataTransfer.setData("text/plain",a.dataset.sheetId),requestAnimationFrame(()=>{a.classList.add("opacity-50","scale-95")})}),a.addEventListener("dragend",()=>{a.classList.remove("opacity-50","scale-95"),n=null,s&&s.querySelectorAll(".draggable-item").forEach(c=>{c.classList.remove("ring-2","ring-primary","z-30")})}),a.addEventListener("dragover",c=>{c.preventDefault(),n&&n!==a&&a.classList.add("ring-2","ring-primary","z-30")}),a.addEventListener("dragleave",c=>{a.contains(c.relatedTarget)||a.classList.remove("ring-2","ring-primary","z-30")}),a.addEventListener("drop",c=>{if(c.preventDefault(),c.stopPropagation(),a.classList.remove("ring-2","ring-primary","z-30"),n&&n!==a){const u=s,m=Array.from(u.children),w=m.indexOf(n),L=m.indexOf(a);w<L?u.insertBefore(n,a.nextSibling):u.insertBefore(n,a),o()}})},d=()=>{const a=i();t.innerHTML=`
        <div class="p-4 md:p-8 h-full flex flex-col relative">
                        ...
                        ${a.map(s=>{const c=s.images&&s.images.length>0;return`
                            ...
                            >
                                ...
                                <div class="flex-1 p-6 flex flex-col">
                                    ...
                                    <h3 class="text-xl font-bold text-dark leading-tight line-clamp-2 mb-4 pr-2">${s.title}</h3>
        ...
        `,v(),t.querySelectorAll(".draggable-item").forEach(l)},v=()=>{const a=t.querySelector("#add-sheet-modal"),s=a.querySelector("div"),c=a.querySelector("h3"),u=a.querySelector("p"),m=t.querySelector("#add-sheet-btn"),w=t.querySelector("#cancel-create-btn"),L=t.querySelector("#confirm-create-btn"),x=t.querySelector("#new-sheet-title");let f=null;m.addEventListener("click",()=>{f=null,c.textContent=e("new_note"),u.textContent=e("enter_title_start"),L.textContent=e("create_one"),a.classList.remove("invisible","opacity-0"),a.classList.add("visible","opacity-100"),s.classList.remove("scale-95"),s.classList.add("scale-100"),x.value="",setTimeout(()=>x.focus(),100)});const M=()=>{a.classList.add("invisible","opacity-0"),a.classList.remove("visible","opacity-100"),s.classList.add("scale-95"),s.classList.remove("scale-100")};w.addEventListener("click",M),L.addEventListener("click",()=>{const j=x.value.trim();if(!j){x.classList.add("ring-2","ring-red-500/50","border-red-500"),x.focus();return}if(f){const E=p.cheatsheets.find(r=>r.id===f);E&&(E.title=j,z(),M(),d())}else{const E={id:Date.now(),title:j,tags:[],content:"",images:[]};p.cheatsheets.push(E),z(),M(),d()}}),x.addEventListener("keydown",j=>{j.key==="Enter"&&L.click(),x.classList.remove("ring-2","ring-red-500/50","border-red-500")}),window.editSheet=j=>{const E=p.cheatsheets.find(r=>r.id===j);E&&(f=j,x.value=E.title,c.textContent=e("edit_note"),u.textContent=e("update_note_title"),L.textContent=e("save"),a.classList.remove("invisible","opacity-0"),a.classList.add("visible","opacity-100"),s.classList.remove("scale-95"),s.classList.add("scale-100"),setTimeout(()=>x.focus(),100))};let S=null;const _=t.querySelector("#delete-sheet-modal"),B=_.querySelector("div");window.deleteSheet=j=>{S=j,_.classList.remove("invisible","opacity-0"),_.classList.add("visible","opacity-100"),B.classList.remove("scale-95"),B.classList.add("scale-100")},t.querySelector("#cancel-delete-btn").addEventListener("click",()=>{_.classList.add("invisible","opacity-0"),_.classList.remove("visible","opacity-100"),B.classList.add("scale-95"),B.classList.remove("scale-100"),S=null}),t.querySelector("#confirm-delete-btn").addEventListener("click",()=>{if(S){const j=p.cheatsheets.findIndex(E=>E.id===S);if(j>-1){const E=localStorage.getItem("cheatsheetsLayout");if(E){let r=JSON.parse(E);r=r.filter(b=>b!==S),localStorage.setItem("cheatsheetsLayout",JSON.stringify(r))}p.cheatsheets.splice(j,1),z(),d()}}})};d()}function Ee(t,n){const o=parseInt(n);let i=p.cheatsheets.find(v=>v.id===o);if(!i){t.innerHTML=`<div class="p-10 text-center text-gray-500">${e("sheet_not_found")}</div>`;return}i.images||(i.images=[]);const l=()=>{t.innerHTML=`
        <div class="h-full flex flex-col relative bg-white overflow-hidden">
            ...
            <header class="flex flex-row items-center justify-between gap-4 px-4 py-4 md:px-8 md:py-6 border-b border-gray-100 bg-white z-10 shrink-0">
                <div class="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div class="flex-1 flex items-center gap-2 overflow-hidden min-w-0">
                        <!-- Title Display -->
                        <h1 id="display-title" class="text-2xl md:text-3xl font-bold text-dark truncate cursor-default">${i.title}</h1>
                        
                        <!-- Title Input (Hidden by default) -->
                        <input type="text" id="title-input" value="${i.title}" class="hidden text-2xl md:text-3xl font-bold text-dark bg-transparent border-b-2 border-primary outline-none focus:ring-0 placeholder-gray-300 w-full min-w-[100px]" placeholder="${e("untitled_note")}">
                    </div>
                </div>
            ...
            <div id="split-container" class="flex-1 flex flex-col md:flex-row overflow-hidden relative">
                ...
                <div id="left-pane" class="w-full md:w-1/2 flex flex-col p-4 md:p-8 bg-white h-1/2 md:h-auto" style="">
                    ...
                    <textarea id="content-editor" class="flex-1 w-full resize-none text-lg text-gray-700 leading-relaxed focus:outline-none placeholder-gray-300 font-medium bg-transparent custom-scrollbar" placeholder="${e("start_typing_placeholder")}">${i.content||""}</textarea>
                </div>
        ...
        `,d()},d=()=>{const v=t.querySelector("#title-input"),a=t.querySelector("#display-title"),s=t.querySelector("#edit-title-btn"),c=t.querySelector("#content-editor"),u=t.querySelector("#back-btn"),m=t.querySelector("#delete-btn"),w=t.querySelector("#add-img-btn"),L=t.querySelector("#file-input"),x=t.querySelector("#resizer"),f=t.querySelector("#left-pane"),M=t.querySelector("#split-container"),S=t.querySelector("#delete-note-modal"),_=S.querySelector("div"),B=t.querySelector("#cancel-delete-modal-btn"),j=t.querySelector("#confirm-delete-modal-btn"),E=t.querySelector("#delete-image-modal"),r=E.querySelector("div"),b=t.querySelector("#cancel-delete-img-btn"),h=t.querySelector("#confirm-delete-img-btn");u.onclick=()=>window.navigateTo("cheatsheets");const $=()=>{i.title=v.value.trim()||e("untitled_note"),i.content=c.value,a.textContent=i.title,z()},g=()=>{a.classList.add("hidden"),v.classList.remove("hidden"),v.focus()},y=()=>{a.classList.remove("hidden"),v.classList.add("hidden"),$()};s&&(s.onclick=g),v.onblur=y,v.onkeydown=I=>{I.key==="Enter"&&y()},c.onblur=$;let k=!1;x.addEventListener("pointerdown",I=>{k=!0,x.setPointerCapture(I.pointerId),M.classList.add("select-none"),x.classList.add("bg-primary/50")}),x.addEventListener("pointermove",I=>{if(!k)return;const C=M.getBoundingClientRect(),T=I.clientX-C.left,A=200,V=C.width-200,W=Math.max(A,Math.min(T,V))/C.width*100;f.style.width=`${W}%`}),x.addEventListener("pointerup",I=>{k=!1,x.releasePointerCapture(I.pointerId),M.classList.remove("select-none"),x.classList.remove("bg-primary/50")});const H=()=>{S.classList.add("invisible","opacity-0"),S.classList.remove("visible","opacity-100"),_.classList.add("scale-95"),_.classList.remove("scale-100")};m.onclick=()=>{S.classList.remove("invisible","opacity-0"),S.classList.add("visible","opacity-100"),_.classList.remove("scale-95"),_.classList.add("scale-100")},B.onclick=H,j.onclick=()=>{const I=p.cheatsheets.findIndex(C=>C.id===o);if(I>-1){p.cheatsheets.splice(I,1);const C=localStorage.getItem("cheatsheetsLayout");if(C){let T=JSON.parse(C);T=T.filter(A=>parseInt(A)!==o),localStorage.setItem("cheatsheetsLayout",JSON.stringify(T))}z(),window.navigateTo("cheatsheets")}},w.onclick=()=>L.click(),L.onchange=I=>{const C=I.target.files[0];if(C){const T=new FileReader;T.onload=A=>{i.images.push(A.target.result),z(),l()},T.readAsDataURL(C)}};let D=null;const q=()=>{E.classList.add("invisible","opacity-0"),E.classList.remove("visible","opacity-100"),r.classList.add("scale-95"),r.classList.remove("scale-100"),D=null};window.deleteImage=I=>{D=I,E.classList.remove("invisible","opacity-0"),E.classList.add("visible","opacity-100"),r.classList.remove("scale-95"),r.classList.add("scale-100")},b.onclick=q,h.onclick=()=>{D!==null&&(i.images.splice(D,1),z(),l(),q())},window.openImageViewer=I=>{const C=document.getElementById("image-viewer-modal"),T=document.getElementById("image-viewer-img");T.src=i.images[I],C.classList.remove("hidden"),setTimeout(()=>{C.classList.remove("opacity-0"),T.classList.remove("scale-95"),T.classList.add("scale-100")},10)},window.closeImageViewer=()=>{const I=document.getElementById("image-viewer-modal"),C=document.getElementById("image-viewer-img");I.classList.add("opacity-0"),C.classList.remove("scale-100"),C.classList.add("scale-95"),setTimeout(()=>{I.classList.add("hidden"),C.src=""},300)}};l()}function Te(t){p.notebook||(p.notebook={notes:[{id:1,title:e("welcome_title"),content:e("welcome_body"),date:new Date().toISOString(),paperStyle:"lined"}]},z());let n=p.notebook.notes.length>0?p.notebook.notes[0].id:null,o=0;const i=s=>{s&&(s.pages||(s.pages=[s.content||""],delete s.content))},l=()=>p.notebook.notes.find(s=>s.id===n),d=()=>{const s=l();i(s);const c=s?s.pages[o]:"";t.innerHTML=`
            ...
            <header class="flex flex-wrap lg:flex-nowrap justify-between items-center mb-2 lg:mb-8 shrink-0 gap-3 lg:gap-4">
                 ...
                 <div class="flex items-center gap-2 w-auto order-2 lg:order-3 justify-end ml-auto">
                      ...
                      <div class="flex items-center bg-white rounded-xl shadow-sm border border-gray-200 p-1 shrink-0">
                        <button id="btn-prev-page" class="p-1.5 text-gray-400 hover:text-primary hover:bg-gray-50 rounded-lg transition-colors ${o===0?"opacity-30 cursor-not-allowed":""}" ${o===0?"disabled":""}>
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" /></svg>
                        </button>
                      ...
                      <button id="btn-add-note" class="whitespace-nowrap px-3 py-2 lg:px-4 bg-primary text-white rounded-xl hover:bg-primary-dark transition-colors font-bold text-sm shadow-lg shadow-primary/30 flex items-center gap-2 transform hover:-translate-y-0.5 active:translate-y-0 shrink-0">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg>
                        <span class="hidden lg:inline">${e("new_notebook")}</span>
                    </button>
                 </div>
                 
                 <!-- Second Row (Mobile): Editor Toolbar -->
                 <div class="w-full lg:w-auto order-3 lg:order-2 lg:ml-6 lg:pl-6 border-l-0 lg:border-l border-gray-300/50 flex items-center ${s?"":"opacity-50 pointer-events-none"} transition-opacity relative justify-center lg:justify-start">
                ...
                <div class="w-full lg:w-80 h-auto lg:h-auto bg-gray-50 flex-none flex flex-row lg:flex-col border-r-0 lg:border-r border-b lg:border-b-0 border-gray-200 z-10 shrink-0 overflow-x-auto lg:overflow-visible">
                    ...
                    <div class="flex flex-row lg:flex-col flex-1 lg:overflow-y-auto overflow-x-auto lg:overflow-x-hidden p-2 lg:p-3 gap-2 lg:gap-0 lg:space-y-2 custom-scrollbar">
                        ${p.notebook.notes.map(u=>`
                            <div class="note-item p-3 lg:p-4 rounded-xl cursor-pointer transition-all border border-transparent min-w-[160px] lg:min-w-0 w-40 lg:w-auto flex-shrink-0 ${u.id===n?"bg-white shadow-md border-gray-100 ring-1 ring-primary/5":"bg-white/40 hover:bg-white/60 hover:border-gray-100 text-gray-500"}" data-id="${u.id}">
                                <h4 class="font-bold text-dark truncate mb-1 text-sm lg:text-base">${u.title||e("untitled_note")}</h4>
                                <p class="text-xs text-gray-400 truncate hidden lg:block">${a(u.pages?u.pages[0]:u.content||"").substring(0,40)||e("empty_note")}</p>
                                <div class="mt-1 lg:mt-2 text-[10px] text-gray-300 font-medium tracking-wide flex justify-between items-center">
                                   <span>${new Date(u.date).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</span>
                                   ${u.id===n?`
                    ...
                    ${s?`
                        ...
                        <div class="flex-1 overflow-y-auto custom-scrollbar relative bg-white">
                             ...
                             <div class="relative z-10 px-4 pt-14 pb-12 lg:px-16 lg:pt-14 lg:pb-12 min-h-full">
                                  <!-- Title Input -->
                                  <input type="text" id="note-title-input" class="w-full text-2xl lg:text-3xl font-bold text-dark bg-transparent border-none focus:ring-0 placeholder-gray-300 mb-10 h-10 p-0 font-display leading-[2.5rem]" value="${s.title}" placeholder="${e("page_title_placeholder")}">
        ...
        `,v(s)},v=s=>{t.querySelectorAll(".note-item").forEach(S=>{S.addEventListener("click",_=>{_.target.closest(".btn-delete-note")||(n=parseInt(S.dataset.id),o=0,d())})});const c=t.querySelector("#btn-add-note");c&&c.addEventListener("click",()=>{const S={id:Date.now(),title:e("new_notebook"),pages:[""],date:new Date().toISOString(),category:"General",paperStyle:"lined"};p.notebook.notes.push(S),n=S.id,z(),d()});const u=t.querySelector("#delete-note-modal"),m=u.querySelector("div"),w=t.querySelector("#cancel-delete-note"),L=t.querySelector("#confirm-delete-note");let x=null;const f=()=>{u.classList.add("invisible","opacity-0"),u.classList.remove("visible","opacity-100"),m.classList.add("scale-95"),m.classList.remove("scale-100"),x=null},M=S=>{x=S,u.classList.remove("invisible","opacity-0"),u.classList.add("visible","opacity-100"),m.classList.remove("scale-95"),m.classList.add("scale-100")};if(t.querySelectorAll(".btn-delete-note").forEach(S=>{S.addEventListener("click",_=>{_.stopPropagation(),M(parseInt(S.closest(".note-item").dataset.id))})}),w.addEventListener("click",f),L.addEventListener("click",()=>{x&&(p.notebook.notes=p.notebook.notes.filter(S=>S.id!==x),n===x&&(n=p.notebook.notes.length>0?p.notebook.notes[0].id:null),z(),d())}),s){const S=t.querySelector("#note-title-input");S.addEventListener("input",g=>{const y=p.notebook.notes.find(k=>k.id===n);y&&(y.title=g.target.value,z())}),S.addEventListener("blur",d);const _=t.querySelector("#note-editor");_.addEventListener("input",()=>{const g=p.notebook.notes.find(y=>y.id===n);g&&(g.pages||(g.pages=[""]),g.pages[o]=_.innerHTML,z())}),t.querySelectorAll(".toolbar-btn").forEach(g=>{g.addEventListener("click",y=>{y.preventDefault();const k=g.dataset.cmd;if(k==="cycleAlign"){const H=["left","center","right"],D=g.dataset.state||"left",I=(H.indexOf(D)+1)%H.length,C=H[I],T={left:"justifyLeft",center:"justifyCenter",right:"justifyRight"};document.execCommand(T[C],!1,null),g.dataset.state=C;const A=g.querySelector("path");if(A){const V={left:"M4 6h16M4 12h10M4 18h16",center:"M4 6h16M7 12h10M4 18h16",right:"M4 6h16M10 12h10M4 18h16"};A.setAttribute("d",V[C])}}else{const H=g.dataset.val||null;document.execCommand(k,!1,H)}_.focus()})});const B=t.querySelector("#btn-next-page");B&&B.addEventListener("click",()=>{const g=p.notebook.notes.find(y=>y.id===n);g&&(o<g.pages.length-1?o++:(g.pages.push(""),o++,z()),d())});const j=t.querySelector("#btn-prev-page");j&&j.addEventListener("click",()=>{o>0&&(o--,d())});const E=t.querySelector("#btn-color-picker"),r=t.querySelector("#color-dropdown");E&&r&&(E.addEventListener("click",g=>{if(g.stopPropagation(),g.preventDefault(),r.classList.contains("hidden")){r.classList.remove("hidden");const y=k=>{!r.contains(k.target)&&k.target!==E&&!E.contains(k.target)&&(r.classList.add("hidden"),document.removeEventListener("click",y))};setTimeout(()=>document.addEventListener("click",y),0)}else r.classList.add("hidden")}),r.querySelectorAll("button").forEach(g=>{g.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();const k=g.dataset.color;document.execCommand("foreColor",!1,k),r.classList.add("hidden"),_.focus()})}));const b=t.querySelector("#btn-highlight-picker"),h=t.querySelector("#highlight-dropdown");b&&h&&(b.addEventListener("click",g=>{if(g.stopPropagation(),g.preventDefault(),h.classList.contains("hidden")){h.classList.remove("hidden"),r&&r.classList.add("hidden");const y=k=>{!h.contains(k.target)&&k.target!==b&&!b.contains(k.target)&&(h.classList.add("hidden"),document.removeEventListener("click",y))};setTimeout(()=>document.addEventListener("click",y),0)}else h.classList.add("hidden")}),h.querySelectorAll("button").forEach(g=>{g.addEventListener("click",y=>{y.stopPropagation(),y.preventDefault();const k=g.dataset.color;document.execCommand("hiliteColor",!1,k),h.classList.add("hidden"),_.focus()})}));const $=t.querySelector("#btn-paper-style");$&&$.addEventListener("click",()=>{const g=p.notebook.notes.find(y=>y.id===n);g&&(g.paperStyle=g.paperStyle==="grid"?"lined":"grid",z(),d())})}},a=s=>{let c=document.createElement("DIV");return c.innerHTML=s,c.textContent||c.innerText||""};d()}document.querySelector("#app").innerHTML=`
...
`;if(p.user){if(p.user.customThemeRgb)document.documentElement.style.setProperty("--color-primary-rgb",p.user.customThemeRgb);else if(p.user.themePreference){const t={blue:"37 99 235",purple:"147 51 234",pink:"236 72 153",emerald:"5 150 105",orange:"234 88 12",rose:"225 29 72",lila:"178 106 251"};t[p.user.themePreference]&&document.documentElement.style.setProperty("--color-primary-rgb",t[p.user.themePreference])}p.user.bgPreference==="theme"?document.body.style.backgroundColor="rgb(var(--color-primary-rgb) / 0.04)":document.body.style.backgroundColor=""}const O=document.querySelector("#dashboard");window.navigateTo=(t,n={})=>{const o=t==="course-detail"?"courses":t;de(document.querySelector("#sidebar"),o);const i=document.querySelector("#mobile-nav");if(i){i.innerHTML="",ce(i,o);const l=i.querySelector(".glass");l&&l.classList.add("pointer-events-auto")}O.innerHTML="",t==="dashboard"?_e(O):t==="courses"?$e(O):t==="course-detail"?Ce(O,n.id):t==="exams"?je(O):t==="cheatsheets"?Be(O):t==="cheatsheet-detail"?Ee(O,n.id):t==="notebook"?Te(O):O.innerHTML=`
    ...
    `;document.body.insertAdjacentHTML("beforeend",t),requestAnimationFrame(()=>{document.getElementById("logout-backdrop").classList.remove("opacity-0");const o=document.getElementById("logout-card");o.classList.remove("scale-95","opacity-0"),o.classList.add("scale-100","opacity-100")});const n=()=>{const o=document.getElementById("logout-modal"),i=document.getElementById("logout-backdrop"),l=document.getElementById("logout-card");i.classList.add("opacity-0"),l.classList.remove("scale-100","opacity-100"),l.classList.add("scale-95","opacity-0"),setTimeout(()=>o.remove(),300)};document.getElementById("btn-cancel-logout").addEventListener("click",n),document.getElementById("logout-backdrop").addEventListener("click",n),document.getElementById("btn-confirm-logout").addEventListener("click",()=>{localStorage.removeItem("studyhub_data"),localStorage.removeItem("dashboardLayout"),localStorage.removeItem("coursesLayout"),localStorage.removeItem("cheatsheetsLayout"),localStorage.removeItem("grade_calc_data"),localStorage.removeItem("habit_tracker_data_v3"),localStorage.removeItem("pomodoro_settings"),localStorage.removeItem("dashboard_notes_list"),localStorage.removeItem("scratchpad_current"),localStorage.removeItem("scratchpad_gallery"),localStorage.removeItem("photo_widget_image"),localStorage.removeItem("photo_widget_zoom"),location.reload()})};window.navigateTo("dashboard");p.user.isSetup||Le(document.querySelector("#modal-container"),()=>{window.navigateTo("dashboard")});

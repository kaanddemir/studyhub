export function renderLiveClass(element) {
    element.innerHTML = `
        <div class="bg-white p-6 rounded-3xl shadow-sm mb-6 relative overflow-hidden group">
            <div class="flex justify-between items-center mb-4 relative z-10">
                <h3 class="text-lg font-bold text-dark">Live class</h3>
                <div class="flex items-center gap-1 text-xs bg-green-100 text-green-600 px-2 py-1 rounded-lg font-medium">
            ...
            <div class="flex flex-col items-center mb-4 relative z-10">
                 ...
                 <div class="w-full h-32 bg-secondary/30 rounded-2xl flex items-center justify-center mb-4 relative overflow-hidden">
                    <div class="absolute inset-0 flex items-center justify-center text-primary/20">
                         <svg class="w-16 h-16" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                    </div>
                     <!-- Mock participants -->
                    <div class="flex -space-x-2 absolute bottom-2 right-2">
                        ...
                        <div class="w-6 h-6 rounded-full bg-red-400 border-2 border-white"></div>
                         <div class="w-6 h-6 rounded-full bg-yellow-400 border-2 border-white text-[8px] flex items-center justify-center font-bold text-white">+5</div>
                    </div>
                 </div>
                 
                 <div class="w-full text-left">
                     <div class="text-sm font-bold text-dark mb-1">Class: Higher Math part -2 solution</div>
                     <div class="text-xs text-gray-400 mb-2">Course: SSC 2025 English Revision Basic</div>
                     <div class="flex items-center gap-1 text-[10px] text-gray-400 truncate w-full">
                        <span class="font-medium">Link:</span> <span class="text-blue-500 underline cursor-pointer">meet.google.com/vcx-sja...</span>
                     </div>
                 </div>
            </div>
            
            <button class="w-full py-3 bg-white border border-gray-200 rounded-xl text-sm font-bold text-dark hover:bg-primary hover:text-white hover:border-transparent transition-all shadow-sm">
                Join The Class
            </button>
        </div>
    `
...
export function renderProfile(element, user) {
    ...
    if (!user.university) user.university = "University Name";
